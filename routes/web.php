...
// New route specifically for the pure Tailwind prototype
Route::get('/figma', function () {
    return view('home');
});
Route::get('/figma/login', function () {
    return view('auth.figma-login');
});
Route::get('/figma/register', function () {
    return view('auth.figma-register');
});
Route::get('/figma/forgot', function () {
    return view('auth.figma-forgot');
});

...
@section('content')
    ...
    {{--
    ========================================================================
    FRONTEND GUIDE: ACCOMMODATION EDIT FORM (V2)
    ========================================================================

    Bagian ini hanya sebagai penanda / panduan untuk tim Frontend Engineer
    membangun UI form sesuai Mockup.

    Data Model Binded: $row (berisi properties hotel ex: $row->title, $row->map_lat dst)
    Endpoint Target (POST): {{ route('accommodation.store', ['id' => $row->id]) }}

...
@section('content')
    {{-- VENDOR BOOKING DETAIL PAGE (3 TABS) --}}
    {{-- Route: GET /vendor/booking-history/{id} --}}
    ...
    Note: Karena Virtuard Booking System defaultnya tidak membedakan "Personal Info" dan "Guest Info" (keduanya adalah sama
    karena customer mengisi data saat checkout),
    Tab "Guest Information" dapat menggunakan variabel `$personal_info` yang persis sama.
    --}}

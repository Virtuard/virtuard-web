        ...
        <div class="bravo_search_tour">
            <div class="bravo_filter">
                <form class="bravo_form_filter" action="{{ route('explore.index') }}">
                    ...
                    <!-- Attributes -->
                    @php
                        $attributes = \Modules\Core\Models\Attributes::where('service', 'hotel')
                            ...
                            <div class="form-group mt-3">
                                <div class="form-content">
                                    ...
                                    <div class="input-search">
                                        <input type="range" id="hotel_search_radius" class="filter-search-radius" name="search_radius"
                                            min="0" max="500" class="w-100 cursor-pointer" value="0" data-id="hotel" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">

                            ...
                            <div class="form-group mt-3">
                                <div class="form-content">
                                    ...
                                    <div class="input-search">
                                        <input type="range" id="natural_search_radius" class="filter-search-radius" name="search_radius"
                                            min="0" max="500" class="w-100 cursor-pointer" value="0" data-id="natural" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">

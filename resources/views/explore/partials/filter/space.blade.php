        ...
        <div class="bravo_search_tour">
            <div class="bravo_filter">
                <form class="bravo_form_filter" action="{{ route('explore.index') }}">
                    ...
                    <!-- Attributes -->
                    @php
                        $attributes = \Modules\Core\Models\Attributes::where('service', 'space')
                    ...
                    <div class="g-filter-item">
                        <div class="item-content">
                            <div class="form-group">
                                <div class="form-content">
                                    <div class="smart-search d-flex justify-content-between align-items-center">
                                        <input type="text" class="form-control filter_map_place"
                                            id="space_map_place" name="map_place" placeholder="Place"
                                            data-id="space"
                                ...
                                <div class="form-group">
                                    <input type="hidden" id="space_map_lat" name="map_lat" class="form-control filter_map_lat">
                                    <input type="hidden" id="space_map_lgn" name="map_lgn" class="form-control filter_map_lgn">
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <div class="form-content">
                                    <label class="mb-2">{{ __('Proximity') }} <span id="space_proximity_text">0</span> km</label>
                                    <div class="input-search">
                                        <input type="range" id="space_search_radius" class="filter-search-radius" name="search_radius"
                                            min="0" max="500" class="w-100 cursor-pointer" value="0" data-id="space" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">

...
<body class="bg-white min-h-screen flex text-gray-900 font-sans">
    ...
    <!-- Left Column (Form) -->
    <div class="w-full lg:w-1/2 flex flex-col px-8 sm:px-16 md:px-24 py-10 overflow-y-auto">
        <div class="max-w-md w-full mx-auto flex flex-col flex-grow justify-center">
            ...
            <a href="/figma/login"
                ...
                <i class="fa-solid fa-arrow-left group-hover:-translate-x-1 transition-transform"></i> Register Page |
                Virtuard Main Web
            </a>
            ...
            <div class="mb-10">
                ...
                <p class="text-gray-500 text-sm">Please create an account to start using Virtuard.</p>
            </div>
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="flex items-start gap-3 mt-6">
                    <input type="checkbox" id="terms"
                        class="mt-1 w-4 h-4 rounded border-gray-300 text-virtuard-green focus:ring-virtuard-green">
                    <label for="terms" class="text-sm text-gray-600">
                        I agree to the <a href="#" class="font-bold text-virtuard-dark hover:underline">Terms of
                            Service</a> and <a href="#" class="font-bold text-virtuard-dark hover:underline">Privacy
                            Policy</a>.
                    </label>
                </div>
                ...
                <!-- Register Button -->
                <button type="submit"
                    class="w-full bg-virtuard-dark hover:bg-black text-white py-3.5 rounded-xl font-bold transition-colors mt-6 shadow-lg shadow-gray-200">
                    Create Account
                </button>
            </form>
            ...
            <div class="relative flex items-center py-8">
                ...
                <span class="flex-shrink-0 mx-4 text-gray-400 text-sm">Or register with</span>
                <div class="flex-grow border-t border-gray-200"></div>
            </div>
            ...
            <p class="text-center text-sm font-medium mt-10">
                Already have an account? <a href="/figma/login"
                    class="text-virtuard-green font-bold hover:underline">Log in</a>
            </p>
        </div>
    </div>

    <!-- Right Column (Abstract Fluid Image) -->

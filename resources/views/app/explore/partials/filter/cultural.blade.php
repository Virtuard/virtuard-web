    ...
    <div class="card-body">
        <div class="bravo_search_tour">
            <div class="bravo_filter">
                <form id="form_explore_cultural" class="bravo_form_filter" action="{{ route('explore.index') }}">
                    ...
                    <div class="g-filter-item">
                        <div class="item-content">
                            <div class="form-group">
                                <div class="form-content">
                                    <div class="smart-search d-flex justify-content-between align-items-center">
                                        <input type="text" class="form-control filter_map_place"
                                            id="cultural_map_place" name="map_place" placeholder="Place"
                                            data-id="cultural"
                                ...
                                <div class="form-group">
                                    <input type="hidden" id="cultural_map_lat" name="map_lat" class="form-control filter_map_lat">
                                    <input type="hidden" id="cultural_map_lgn" name="map_lgn" class="form-control filter_map_lgn">
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <div class="form-content">
                                    <label class="mb-2">{{ __('Proximity') }} <span id="cultural_proximity_text">0</span> mil</label>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a class="btn btn-secondary form-control p-0"
                                    href="{{ route('explore.index', ['service_type' => 'cultural']) }}"

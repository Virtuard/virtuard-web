<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('hotel.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Edit: ').$row->title : __('Add new business')); ?></h1>
                    <?php if($row->slug): ?>
                ...
                <div class="">
                    ...
                    <?php endif; ?>
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-xs" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("View Business")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label><?php echo e(__('Business Featured')); ?></label>
                                        <br>
                                        <label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/modules/Hotel/Views/admin/detail.blade.php ENDPATH**/ ?>
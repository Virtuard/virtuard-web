                                ...
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="categories" role="tabpanel"
                                            ...
                                            <?php $__currentLoopData = $businessCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $businessCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-12 mb-4">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        style="background-image:url('https://source.unsplash.com/600x900/?<?php echo e($businessCategory->title); ?>');">
                                                        <div
                                                            ...
                                                            <div>
                                                                <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                        herf="https://creativemanner.com"><?php echo e($businessCategory->title); ?></a>
                                                                </h4>
                                ...
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            ...
                                            <span>Showing <?php echo e(count($business)); ?> Result</span>
                                            <i class="fa fa-lg fa-arrow-right cursor-pointer"></i>
                                        </div>
                                        <?php $__currentLoopData = $business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $businessItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 mb-4">
                                                <div class="card">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        style="background-image: url('/uploads/<?php echo e($businessItem->image->file_path); ?>'); height: 250px;">
                                                        <div class="card-img-overlay d-flex align-items-end">
                                                            <?php if($businessItem->image && $businessItem->image->file_path): ?>
                                                                <img src="/uploads/<?php echo e($businessItem->image->file_path); ?>"
                                                                    alt="rumah"
                                                                    style="width:50px; height:50px;border-radius:50%">
                                                            <?php else: ?>
                                                                <img src="https://source.unsplash.com/600x900/?avatar <?php echo e($businessItem->title); ?>"
                                                                    alt="rumah"
                                                                    style="width:50px; height:50px;border-radius:50%">
                                                            <?php endif; ?>
                                                            <div class="ml-2">
                                                                <h4 class="card-title mt-0 mb-0"
                                                                    ...
                                                                    <a class="text-white"><?php echo e($businessItem->title); ?></a>
                                                                </h4>
                                                                <span class="text-white"> <i class="fa fa-map-marker"></i>
                                                                    <?php echo e($businessItem->address); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            ...
                                            <span>Showing <?php echo e($hotels->count()); ?> Result</span>
                                            ...
                                            <div class="col-12 mb-4">
                                                <div class="card">
                                                    <a href="<?php echo e(url('hotel/' . $hotel->slug)); ?>">
                                                        <div class="card card-custom card-has-bg click-col"
                                                            style="background-image:url('<?php echo e(url('uploads/' . ($hotel->image->file_path ?? 'demo/hotel/gallery/hotel-gallery-1.jpg'))); ?>'); height: 250px;">
                                                            <div class="card-img-overlay d-flex align-items-end">
                                                                <img src="https://source.unsplash.com/600x900/?house"
                                                                    alt="rumah"
                                                                    style="width:50px; height:50px;border-radius:50%">
                                                                <div class="ml-2">
                                                                    <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                            herf="<?php echo e(url('hotel/' . $hotel->slug)); ?>"><?php echo e($hotel->title ?? 'Hotel'); ?></a>
                                                                    </h4>
                                                                    <span class="text-white"> <i
                                                                            class="fa fa-map-marker"></i>
                                                                        <?php echo e($hotel->address ?? 'No address'); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <p class="card-title mt-0 mb-0 text-dark">
                                                                        <?php echo e($hotel->user->name ?? 'Virtuard'); ?></p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center">
                                                                <button class="btn btn-sm" type="button">
                            ...
                            <div class="col-4">
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <i class="fa fa-lg fa-arrow-left"></i>
                                            <span>Showing <?php echo e($properties->count()); ?> Result</span>
                                            <i class="fa fa-lg fa-arrow-right"></i>
                                        </div>
                                        <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 mb-4">
                                                <div class="card">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        style="background-image:url('<?php echo e(url('uploads/' . ($property->image->file_path ?? 'demo/hotel/gallery/hotel-gallery-1.jpg'))); ?>'); height: 250px;">
                                                        <div class="card-img-overlay d-flex align-items-end">
                                                            <img src="https://source.unsplash.com/600x900/?house"
                                                                alt="rumah"
                                                                style="width:50px; height:50px;border-radius:50%">
                                                            <div class="ml-2">
                                                                <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                        href="<?php echo e(url('space/' . $property->slug)); ?>"><?php echo e($property->title); ?></a>
                                                                </h4>
                                                                <span class="text-white"> <i class="fa fa-map-marker"></i>
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <p class="card-title mt-0 mb-0 text-dark">
                                                                        <?php echo e($property->user->business_name ?? 'Virtuard'); ?>
                            ...
                            <div class="col-4">
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <i class="fa fa-lg fa-arrow-left"></i>
                                            <span>Showing <?php echo e($cars->count()); ?> Result</span>
                                            <i class="fa fa-lg fa-arrow-right"></i>
                                        </div>
                                        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 mb-4">
                                                <div class="card">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        style="background-image:url('<?php echo e(url('uploads/' . ($car->image->file_path ?? 'demo/hotel/gallery/hotel-gallery-1.jpg'))); ?>'); height: 250px;">
                                                        <div class="card-img-overlay d-flex align-items-end">
                                                            <img src="https://source.unsplash.com/600x900/?house"
                                                                alt="rumah"
                                                                style="width:50px; height:50px;border-radius:50%">
                                                            <div class="ml-2">
                                                                <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                        href="<?php echo e(url('car/' . $car->slug)); ?>"><?php echo e($car->title); ?></a>
                                                                </h4>
                                                                <span class="text-white"> <i class="fa fa-map-marker"></i>
                                                                    <?php echo e($car->address); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <p class="card-title mt-0 mb-0 text-dark">
                                                                        <?php echo e($car->user->business_name); ?>
                            ...
                            <div class="col-4">
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <i class="fa fa-lg fa-arrow-left"></i>
                                            <span>Showing <?php echo e($events->count()); ?> Result</span>
                                            <i class="fa fa-lg fa-arrow-right"></i>
                                        </div>
                                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 mb-4">
                                                <div class="card">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        style="background-image:url('<?php echo e(url('uploads/' . ($event->image->file_path ?? 'demo/hotel/gallery/hotel-gallery-1.jpg'))); ?>'); height: 250px;">
                                                        <div class="card-img-overlay d-flex align-items-end">
                                                            ...
                                                            <div class="ml-2">
                                                                <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                        href="<?php echo e(url('event/' . $event->slug)); ?>"><?php echo e($event->title); ?></a>
                                                                </h4>
                                                                <span class="text-white"> <i class="fa fa-map-marker"></i>
                                                                    <?php echo e($event->address); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <p class="card-title mt-0 mb-0 text-dark">
                                                                        <?php echo e($event->user->business_name ?? 'Virtuard'); ?>
                            ...
                            <div class="col-4">
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <i class="fa fa-lg fa-arrow-left"></i>
                                            <span>Showing <?php echo e($flights->count()); ?> Result</span>
                                            <i class="fa fa-lg fa-arrow-right"></i>
                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        ...
                                                        <div class="card-img-overlay d-flex align-items-end">
                                                            ...
                                                            <div class="ml-2">
                                                                <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                        href="<?php echo e(url('flight')); ?>"><?php echo e($flight->title); ?></a>
                                                                </h4>
                                                                <span class="text-white">
                                                                    <?php echo e($flight->code); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <p class="card-title mt-0 mb-0 text-dark">
                                                                        <?php echo e($flight->user->business_name ?? 'Virtuard'); ?>
                            ...
                            <div class="col-4">
                                <div class="card" style="height: 600px; overflow-y: auto;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <i class="fa fa-lg fa-arrow-left"></i>
                                            <span>Showing <?php echo e($cars->count() + $boats->count()); ?> Result</span>
                                            <i class="fa fa-lg fa-arrow-right"></i>
                                        </div>
                                        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 mb-4">
                                        ...
                                        <?php $__currentLoopData = $boats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $boat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 mb-4">
                                                <div class="card">
                                                    <div class="card card-custom card-has-bg click-col"
                                                        style="background-image:url('<?php echo e(url('uploads/' . ($boat->image->file_path ?? 'demo/hotel/gallery/hotel-gallery-1.jpg'))); ?>'); height: 250px;">
                                                        <div class="card-img-overlay d-flex align-items-end">
                                                            ...
                                                            <div class="ml-2">
                                                                <h4 class="card-title mt-0 mb-0"><a class="text-white"
                                                                        href="<?php echo e(url('boat/' . $boat->slug)); ?>"><?php echo e($boat->title); ?></a>
                                                                </h4>
                                                                <span class="text-white"> <i
                                                                        class="fa fa-map-marker"></i>
                                                                    <?php echo e($boat->address); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    <p class="card-title mt-0 mb-0 text-dark">
                                                                        <?php echo e($boat->user->business_name); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/resources/views/explore/index.blade.php ENDPATH**/ ?>
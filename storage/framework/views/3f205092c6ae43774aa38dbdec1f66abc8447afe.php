<div id="hotel-rooms" class="hotel_rooms_form" v-cloak="" :class="{'d-none':enquiry_type!='book'}">
    <?php if($data['ipanorama']): ?>
        <div id="panorama"></div>
    <?php endif; ?>
    
    <?php if($data['category_product'] === 'Restaurant and Cafes'): ?>
        <h3 class="heading-section"><?php echo e(__('Available Table')); ?></h3>
    <?php elseif($data['category_product'] === 'Shops'): ?>
        <h3 class="heading-section"><?php echo e(__('Available Shop')); ?></h3>
    <?php elseif($data['category_product'] === 'Clinic/Doctor/Dentist' || $data['category_product'] === 'Other service'): ?>
        <h3 class="heading-section"><?php echo e(__('Available Time')); ?></h3>
    <?php else: ?>
    ...
    <div class="nav-enquiry">
        <div class="active" >
            <span><?php echo e(__("Booking Restaurant and Cafes")); ?></span>
        </div>
    </div>
    <?php else: ?>
    ...
    <div class="form-book">
        <div class="form-search-rooms">
            <div class="d-flex form-search-row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-content dropdown-toggle" data-toggle="dropdown">
                                <label class="form-label"><?php echo e(__('Number of Table')); ?></label>
                                <div class="render">
                                    <span class="adults" >
                                        <span class="one" >{{adults}}
                                            <span v-if="adults < 2"><?php echo e(__('Table')); ?></span>
                                            <span v-else><?php echo e(__('Table')); ?></span>
                                        </span>
                                    </span>
                                </div>
                            </div>
                            <div class="dropdown-menu select-guests-dropdown" >
                                <div class="dropdown-item-row">
                                    <div class="label"><?php echo e(__('Table')); ?></div>
                                    <div class="val">
                ...
                <?php elseif($data['category_product'] === 'Shops' || $data['category_product'] === 'Clinic/Doctor/Dentist' || $data['category_product'] === 'Other service'): ?>
                    <div class="col-md-8">
                        <div class="form-group form-date-field form-date-search " @click="openStartDate" data-format="<?php echo e(get_moment_date_format()); ?>">
                            <i class="fa fa-angle-down arrow"></i>
                            <input type="text" class="start_date" ref="start_date" style="height: 1px; visibility: hidden">
        ...
        <div class="alert alert-warning" v-if="!firstLoad && !rooms.length">
            <?php echo e(__("No table available with your selected date. Please change your search critical")); ?>

        </div>
        <?php elseif($data['category_product'] === 'Shops' || $data['category_product'] === 'Clinic/Doctor/Dentist' || $data['category_product'] === 'Other service'): ?>
        <div class="alert alert-warning" v-if="!firstLoad && !rooms.length">
            <?php echo e(__("No time available with your selected date. Please change your search critical")); ?>
...
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/themes/BC/Hotel/Views/frontend/layouts/details/hotel-rooms.blade.php ENDPATH**/ ?>
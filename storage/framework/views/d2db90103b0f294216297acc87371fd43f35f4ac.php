                ...
                <?php $__currentLoopData = $tour_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-<?php echo e($field['size'] ?? "4"); ?> border-right">
                        <?php switch($field['field']):
                            ...
                            <?php break; ?>
                            <?php case ('Nearby'): ?>
                                <?php echo $__env->make('Tour::frontend.layouts.search.fields.range', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php break; ?>
                        <?php endswitch; ?>
                    </div>
...
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/themes/BC/Tour/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>
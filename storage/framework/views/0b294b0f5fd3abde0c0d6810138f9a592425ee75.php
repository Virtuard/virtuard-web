...
<div class="g-rules">
    ...
    <div class="description">
        <?php if($data['category_product'] === 'Restaurant and Cafes' || $data['category_product'] === 'Shops' || $data['category_product'] === 'Clinic/Doctor/Dentist' || $data['category_product'] === 'Other service'): ?>
        <div class="row">
            <div class="col-lg-4">
                <div class="key"><?php echo e(__("Open")); ?></div>
            </div>
            <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="key"><?php echo e(__("Closed")); ?></div>
            </div>
            <div class="col-lg-8">
...
<?php endif; ?>
<div class="bravo-hr"></div>
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/themes/BC/Hotel/Views/frontend/layouts/details/hotel-detail.blade.php ENDPATH**/ ?>
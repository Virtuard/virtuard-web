...
<div class="sidebar-user">
    ...
    <div class="sidebar-menu">
        <ul class="main-menu">
            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($menuItem['title'] === 'Dashboard'): ?>
                    <li class="" position="9">
    ...
    <div class="logout">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form-vendor').submit();"><i
                class="fa fa-sign-out"></i> <?php echo e(__('Log Out')); ?>

        </a>
    </div>
    <div class="logout">
        <a href="<?php echo e(url('/')); ?>" style="color: #1ABC9C"><i class="fa fa-long-arrow-left"></i>
            <?php echo e(__('Back to Homepage')); ?></a>
    </div>
</div>
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/themes/Base/User/Views/frontend/layouts/sidebar.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>Profile of <?php echo e(Auth::user()->name); ?></title>
    <?php
        ...
        <div class="container">
            ...
            <div class="profile">
                ...
                <div class="profile-image" id="profile-instagram">
                    ...
                    <img class="image-demo" src="<?php echo e(get_file_url( old('avatar_id',$dataUser->avatar_id) ) ??  $dataUser->getAvatarUrl() ?? ""); ?>" style="width:152px;"/>

                </div>

                <div class="profile-user-settings">
                    <h1 class="profile-user-name"><?php echo e($dataUser->user_name); ?></h1>
                    <a href="<?php echo e(route('user.profile.setting')); ?>" class="btn profile-edit-btn">Edit Profile</a>
                </div>
                ...
                <div class="profile-stats">
                    ...
                    <ul>
                        ...
                        <li><span class="profile-stat-count"><?php echo e($followed); ?></span> followers</li>
                        <li><span class="profile-stat-count"><?php echo e($following); ?></span> following</li>
                    </ul>
                ...
                <div class="profile-bio mt-2">
                    ...
                    <p><span class="profile-real-name"><?php echo e($dataUser->name); ?></span> <?php echo $dataUser->bio; ?></p>
...
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/themes/Base/User/Views/frontend/profile-setting.blade.php ENDPATH**/ ?>
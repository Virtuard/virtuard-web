...
<body
    class="frontend-page <?php echo e(!empty($row->header_style) ? 'header-' . $row->header_style : 'header-normal'); ?> <?php echo e($body_class ?? ''); ?> <?php if(is_api()): ?> is_api <?php endif; ?>">
    <?php if(!is_demo_mode()): ?>
...
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/modules/Layout/app.blade.php ENDPATH**/ ?>
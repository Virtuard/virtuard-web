...
<div class="profile-summary mb-2">
    ...
    <h3 class="display-name"><?php echo e($user->getDisplayName()); ?>
        ...
        <?php if($user->is_verified): ?>
            <img data-toggle="tooltip" data-placement="top" src="<?php echo e(asset('icon/ico-vefified-1.svg')); ?>"
                title="<?php echo e(__('Verified')); ?>" alt="ico-vefified-1">
        <?php else: ?>
            <img data-toggle="tooltip" data-placement="top" src="<?php echo e(asset('icon/ico-not-vefified-1.svg')); ?>"
                title="<?php echo e(__('Not verified')); ?>" alt="ico-vefified-1">
        <?php endif; ?>
    </h3>
...
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/themes/Base/User/Views/frontend/profile/sidebar.blade.php ENDPATH**/ ?>
<link href="<?php echo e(asset('libs/lightbox2/dist/css/lightbox.css')); ?>" rel="stylesheet" />
<style>
    .item {
        position: relative;
    }
    ...
    <div class="container" style="margin-top:10px;">
        ...
        <div class="list-item story-vendor">
            <div class="d-flex">
                ...
                <?php $__currentLoopData = $storyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="item">
                        <div class="image">
                            <?php if($story): ?>
                                <a href="<?php echo e(asset('uploads/' . $story->media)); ?>" data-lightbox="image-1"
                                    data-title="<?php echo e($story->link_text ?? ''); ?>" data-story="<?php echo e($story->link ?? ''); ?>">
                                    <div class="image-overlay">
                                        <img src="<?php echo e(asset('uploads/' . $story->media)); ?>"
                                            alt="<?php echo e($story->link_text); ?>" class="w-100" style="object-fit: cover;">
                                    </div>
                                </a>
                            <?php endif; ?>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/modules/Vendor/Views/frontend/blocks/list-vendor-story/index.blade.php ENDPATH**/ ?>
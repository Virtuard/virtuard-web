<div class="panel">
    <div class="panel-title"><strong><?php echo e(__('Cultural Haritage and Public Works Content')); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__('Title')); ?></label>
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__('Name of the Cultural Haritage and Public Works Content')); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php if($categories): ?>
    <div class="panel">
        <div class="panel-title"><strong><?php echo e(__('Cultural Haritage and Public Works Category')); ?></strong></div>
        <div class="panel-body">
...
<?php endif; ?>
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/modules/Event/Views/admin/event/content.blade.php ENDPATH**/ ?>
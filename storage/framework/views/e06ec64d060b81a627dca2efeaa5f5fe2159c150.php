        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <label><input type="checkbox" name="enable_rtl" value="1"><?php echo e(__('Enable')); ?></label>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/buac2919/public_html/virtuard.buatpc.com/modules/Core/Views/admin/settings/groups/general.blade.php ENDPATH**/ ?>
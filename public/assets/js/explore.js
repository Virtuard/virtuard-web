...
function initMap() {
    ...
    let initialLat = parseFloat($('#explore_map_lat').val()) || -8.4095;
    let initialLng = parseFloat($('#explore_map_lgn').val()) || 115.1889;
...
function getCenterMarker(mdata) {
    let map_lat = parseFloat($('#explore_map_lat').val()) || -8.4095;
    let map_lng = parseFloat($('#explore_map_lgn').val()) || 115.1889;

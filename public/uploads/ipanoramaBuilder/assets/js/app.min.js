! function() {
  ...
  var $idItem = $params.get("id");
  if ($user_id) {
    $pathUpload = `upload/${$user_id}/${$idItem}`;
  }
  ...
  ! function(a) {
      ...
      return b = b || Error,
        function() {
          ...
          for (h += i.replace(/\{\d+\}/g, function(a) {
            ...
            }), h += "\nhttp://errors.angularjs.org/1.5.8/" + (a ? a + "/" : "") + g, d = e, c = "?"; d < f.length; d++, c = "&") h += c + "p" + (d - e) + "=" + encodeURIComponent(qa(f[d]));
          return new b(h)
        }
    }
    ...
    function d(a, b, e) {
      ...
      if (a)
        ...
        for (f in a) Dd.call(a, f) && b.call(e, a[f], f, a);
      return a
    }
      ...
      for (var d = a.$$hashKey, e = 0, f = b.length; f > e; ++e) {
        ...
        if (t(g) || y(g))
          for (var j = Object.keys(g), k = 0, l = j.length; l > k; k++) {
            var m = j[k],
              n = g[m];
            c && t(n) ? x(n) ? a[m] = new Date(n.valueOf()) : z(n) ? a[m] = new RegExp(n) : n.nodeName ? a[m] = n.cloneNode(!0) : J(n) ? a[m] = n.clone() : (t(a[m]) || (a[m] = Ud(n) ? [] : {}), i(a[m], [n], !0)) : a[m] = n
          }
      }
      return h(a, d), a
    }
    ...
    function N(a, b) {
      function c(a, b) {
        ...
        if (Ud(a))
          ...
          for (c in a) Dd.call(a, c) && (b[c] = e(a[c]));
        return h(b, d), b
      }
      ...
      function e(a) {
        ...
        var d = !1,
          e = f(a);
        return void 0 === e && (e = Ud(a) ? [] : Object.create(Qd(a)), d = !0), g.push(a), i.push(e), d ? c(a, e) : e
      }
      ...
      var g = [],
        i = [];
      if (b) {
        if (H(b) || I(b)) throw Rd("cpta", "Can't copy! TypedArray destination cannot be mutated.");
        if (a === b) throw Rd("cpi", "Can't copy! Source and destination are identical.");
        return Ud(b) ? b.length = 0 : d(b, function(a, c) {
    ...
    function O(a, b) {
      ...
      if (f == g && "object" == f) {
        if (!Ud(a)) {
          ...
          if (B(a) || B(b) || A(a) || A(b) || Ud(b) || x(b) || z(b)) return !1;
          e = ma();
          for (d in a)
            if ("$" !== d.charAt(0) && !y(a[d])) {
    ...
    function Y(a) {
      ...
      try {
        return a[0].nodeType === ee ? Ed(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(a, b) {
          return "<" + Ed(b)
        })
      } catch (b) {
        return Ed(c)
    ...
    function $(a) {
      ...
      return d((a || "").split("&"), function(a) {
        var c, d, e;
        a && (d = a = a.replace(/\+/g, "%20"), c = a.indexOf("="), -1 !== c && (d = a.substring(0, c), e = a.substring(c + 1)), d = Z(d), s(d) && (e = s(e) ? Z(e) : !0, Dd.call(b, d) ? Ud(b[d]) ? b[d].push(e) : b[d] = [b[d], e] : b[d] = e))
      }), b
    }
    ...
    function ca(b, c, e) {
      ...
      var g = function() {
          if (b = Jd(b), b.injector()) {
            ...
            throw Rd("btstrpd", "App already bootstrapped with this element '{0}'", d.replace(/</, "&lt;").replace(/>/, "&gt;"))
          }
      ...
      return a && h.test(a.name) && (e.debugInfoEnabled = !0, a.name = a.name.replace(h, "")), a && !i.test(a.name) ? g() : (a.name = a.name.replace(i, ""), Sd.resumeBootstrap = function(a) {
        return d(a, function(a) {
          c.push(a)
        }), g()
      }, void(y(Sd.resumeDeferredBootstrap) && Sd.resumeDeferredBootstrap()))
    }
    ...
    function ea(a) {
      ...
      if (!b) throw Rd("test", "no injector found for element argument to getTestability");
      return b.get("$$testability")
    }

    function fa(a, b) {
      return b = b || "_", a.replace(ae, function(a, c) {
    ...
    function ga() {
      ...
      if (!be) {
        var c = Zd();
        Kd = r(c) ? a.jQuery : c ? a[c] : void 0, Kd && Kd.fn.on ? (Jd = Kd, j(Kd.fn, {
          scope: xe.scope,
          isolateScope: xe.isolateScope,
          controller: xe.controller,
          injector: xe.injector,
          inheritedData: xe.inheritedData
        }), b = Kd.cleanData, Kd.cleanData = function(a) {
          for (var c, d, e = 0; null != (d = a[e]); e++) c = Kd._data(d, "events"), c && c.$destroy && Kd(d).triggerHandler("$destroy");
          b(a)
        }) : Jd = Ba, Sd.element = Jd, be = !0
      }
    }
    ...
    function ia(a, b, c) {
      return c && Ud(a) && (a = a[a.length - 1]), ha(y(a), b, "not a function, got " + (a && "object" == typeof a ? a.constructor.name || "Object" : typeof a)), a
    }
    ...
    function la(a) {
      for (var b, c = a[0], d = a[a.length - 1], e = 1; c !== d && (c = c.nextSibling); e++)(b || a[e] !== c) && (b || (b = Jd(Md.call(a, 0, e))), b.push(c));
      return b || a
    }
    ...
    function qa(a) {
      return "function" == typeof a ? a.toString().replace(/ \{[\s\S]*$/, "") : r(a) ? "undefined" : "string" != typeof a ? pa(a) : a
    }
    ...
    function ra(c) {
      ...
      }), (Ld = na(a))("ng", ["ngLocale"], ["$provide", function(a) {
        a.provider({
          $$sanitizeUri: wc
    ...
    function ta(a) {
      return a.replace(ne, function(a, b, c, d) {
    ...
    function ya(a, b) {
      ...
      if (ua(a)) i.push(b.createTextNode(a));
        ...
        for (c = h.appendChild(b.createElement("div")), e = (te.exec(a) || ["", ""])[1].toLowerCase(), f = ve[e] || ve._default, c.innerHTML = f[1] + a.replace(ue, "<$1></$2>") + f[2], g = f[0]; g--;) c = c.lastChild;
    ...
    function za(b, c) {
      c = c || a.document;
      var d;
      return (d = re.exec(b)) ? [c.createElement(d[1])] : (d = ya(b, c)) ? d.childNodes : []
    }
    ...
    function Ba(a) {
      ...
      if (v(a) && (a = Wd(a), b = !0), !(this instanceof Ba)) {
        if (b && "<" != a.charAt(0)) throw qe("nosel", "Looking up elements via selectors is not supported by jqLite! See: http://docs.angularjs.org/api/angular.element");
        return new Ba(a)
      }
    ...
    function Ea(a, b, c, e) {
      if (s(e)) throw qe("offargs", "jqLite#off() does not support the `selector` argument");
      var f = Ga(a),
        g = f && f.events,
        h = f && f.handle;
      if (h)
        if (b) {
          var i = function(b) {
            var d = g[b];
            s(c) && M(d || [], c), s(c) && d && d.length > 0 || (me(a, b, h), delete g[b])
          };
    ...
    function Fa(a, b) {
      ...
      if (d) {
        ...
        d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Ea(a)), delete je[c], a.ng339 = void 0
      }
    }
    ...
    function Ga(a, b) {
      var c = a.ng339,
        d = c && je[c];
      return b && !d && (a.ng339 = c = sa(), d = je[c] = {
        events: {},
        data: {},
        handle: void 0
      }), d
    ...
    function Ja(a, b) {
      b && a.setAttribute && d(b.split(" "), function(b) {
        a.setAttribute("class", Wd((" " + (a.getAttribute("class") || "") + " ").replace(/[\n\t]/g, " ").replace(" " + Wd(b) + " ", " ")))
      })
    }
    ...
    function Qa(b, c) {
      c = c || a, "complete" === c.document.readyState ? c.setTimeout(b) : Jd(c).on("load", b)
    }
    ...
    function ab(a, b, c) {
      ...
      if ("function" == typeof a) {
        if (!(e = a.$inject)) {
          if (e = [], a.length) {
            if (b) throw v(c) && c || (c = a.name || _a(a)), He("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", c);
            f = $a(a), d(f[1].split(Ee), function(a) {
      ...
      } else Ud(a) ? (g = a.length - 1, ia(a[g], "fn"), e = a.slice(0, g)) : ia(a, "fn", !0);
      return e
    }
    ...
    function bb(a, b) {
      ...
      function e(a, b) {
        if (ja(a, "service"), (y(b) || Ud(b)) && (b = x.instantiate(b)), !b.$get) throw He("pget", "Provider '{0}' must define $get factory method.", a);
        return w[a + q] = b
      }
      ...
      function g(a, b) {
        return function() {
          ...
          if (r(c)) throw He("undef", "Provider '{0}' must return a value from $get factory method.", a);
          return c
        }
      }
      ...
      function m(a) {
        ...
        return d(a, function(a) {
          ...
          if (!u.get(a)) {
            u.put(a, !0);
            try {
              v(a) ? (b = Ld(a), c = c.concat(m(b.requires)).concat(b._runBlocks), d(b._invokeQueue), d(b._configBlocks)) : y(a) ? c.push(x.invoke(a)) : Ud(a) ? c.push(x.invoke(a)) : ia(a, "module")
            } catch (e) {
              throw Ud(a) && (a = a[a.length - 1]), e.message && e.stack && -1 == e.stack.indexOf(e.message) && (e = e.message + "\n" + e.stack), He("modulerr", "Failed to instantiate module {0} due to:\n{1}", a, e.stack || e.message || e)
            }
          }
        }), c
      }
      ...
      function n(a, c) {
        function d(b, d) {
          if (a.hasOwnProperty(b)) {
            if (a[b] === o) throw He("cdep", "Circular dependency found: {0}", b + " <- " + s.join(" <- "));
            return a[b]
          }
          try {
        ...
        function e(a, c, e) {
          for (var f = [], g = bb.$$annotate(a, b, e), h = 0, i = g.length; i > h; h++) {
            var j = g[h];
            if ("string" != typeof j) throw He("itkn", "Incorrect injection token! Expected service name as string, got {0}", j);
        ...
        function f(a) {
          return 11 >= Id ? !1 : "function" == typeof a && /^(?:class\b|constructor\()/.test(Za(a))
        }

        function g(a, b, c, d) {
          "string" == typeof c && (d = c, c = null);
          var g = e(a, c, d);
          return Ud(a) && (a = a[a.length - 1]), f(a) ? (g.unshift(null), new(Function.prototype.bind.apply(a, g))) : a.apply(b, g)
        }
      ...
      var o = {},
        ...
        x = w.$injector = n(w, function(a, b) {
          throw Sd.isString(b) && s.push(b), He("unpr", "Unknown provider: {0}", s.join(" <- "))
        }),
        z = {},
        A = n(z, function(a, b) {
          var c = x.get(a + q, b);
    ...
    function db(a, b) {
      return a || b ? a ? b ? (Ud(a) && (a = a.join(" ")), Ud(b) && (b = b.join(" ")), a + " " + b) : a : b : ""
    }
    ...
    function hb(a, b, c, e) {
      ...
      k.onUrlChange = function(b) {
        return B || (e.history && Jd(a).on("popstate", h), Jd(a).on("hashchange", h), B = !0), A.push(b), b
    ...
    function mb(b, c) {
      function e(a, b, c) {
        ...
        return d(a, function(a, d) {
          ...
          var g = a.match(e);
          if (!g) throw Re("iscp", "Invalid {3} for directive '{0}'. Definition: {... {1}: '{2}' ...}", b, d, a, c ? "controller bindings definition" : "isolate scope definition");
          f[d] = {
            mode: g[1][0],
            collection: "*" === g[2],
            optional: "?" === g[3],
      ...
      function g(a, b) {
        ...
        if (t(a.scope) && (a.bindToController === !0 ? (c.bindToController = e(a.scope, b, !0), c.isolateScope = {}) : c.isolateScope = e(a.scope, b, !1)), t(a.bindToController) && (c.bindToController = e(a.bindToController, b, !0)), t(c.bindToController)) {
          var d = a.controller,
            f = a.controllerAs;
          if (!d) throw Re("noctrl", "Cannot bind to controller without directive '{0}'s controller.", b);
          if (!rb(d, f)) throw Re("noident", "Cannot bind to controller without identifier for directive '{0}'.", b)
        }
        return c
      }
      ...
      function h(a) {
        var b = a.charAt(0);
        if (!b || b !== Ed(b)) throw Re("baddir", "Directive/Component name '{0}' is invalid. The first character must be a lowercase letter", a);
        if (a !== a.trim()) throw Re("baddir", "Directive/Component name '{0}' is invalid. The name should not contain leading or trailing whitespaces", a)
      }

      function i(a) {
        var b = a.require || a.controller && a.name;
        return !Ud(b) && t(b) && d(b, function(a, c) {
          var d = a.match(x),
      ...
      this.directive = function E(a, c) {
        return ja(a, "directive"), v(a) ? (h(a), ha(c, "directiveFactory"), k.hasOwnProperty(a) || (k[a] = [], b.factory(a + l, ["$injector", "$exceptionHandler", function(b, c) {
          var e = [];
        ...
        function c(a) {
          ...
          var f = b.template || b.templateUrl ? b.template : "",
            g = {
              controller: e,
              controllerAs: rb(b.controller) || b.controllerAs || "$ctrl",
              template: c(f),
      ...
      this.onChangesTtl = function(a) {
        ...
        function H() {
          try {
            if (!--xa) throw ta = void 0, Re("infchng", "{0} $onChanges() iterations reached. Aborting!\n", D);
            p.$apply(function() {
        ...
        function N(b, c, d, e, f) {
          ...
          for (var g = /\S+/, h = 0, i = b.length; i > h; h++) {
            var j = b[h];
            j.nodeType === ee && j.nodeValue.match(g) && Aa(j, b[h] = a.document.createElement("span"))
          }
          var k = S(b, c, b, d, e, f);
          N.$$addScopeClass(b);
          var l = null;
          return function(a, c, d) {
            ha(a, "scope"), f && f.needsNewScope && (a = a.$parent.$new()), d = d || {};
            var e = d.parentBoundTranscludeFn,
              g = d.transcludeControllers,
              h = d.futureParentElement;
            e && e.$$boundTransclude && (e = e.$$boundTransclude), l || (l = P(h));
            var i;
            if (i = "html" !== l ? Jd(la(l, Jd("<div>").append(b).html())) : c ? xe.clone.call(b) : b, g)
        ...
        function P(a) {
          var b = a && a[0];
          return b && "foreignobject" !== L(b) && Pd.call(b).match(/SVG/) ? "svg" : "html"
        }
        ...
        function S(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            ...
            for (j = 0, k = o.length; k > j;) h = p[o[j++]], f = o[j++], g = o[j++], f ? (f.scope ? (i = a.$new(), N.$$addScopeInfo(Jd(h), i)) : i = a, m = f.transcludeOnThisElement ? T(a, f.transclude, e) : !f.templateOnThisElement && e ? e : !e && b ? T(a, b) : null, f(g, i, h, d, m)) : g && g(a, h.childNodes, void 0, e)
          }
          ...
          switch (h) {
            case ce:
              ...
              for (var j, k, l, m, n, o, p = a.attributes, q = 0, r = p && p.length; r > q; q++) {
                var s = !1,
                  w = !1;
                j = p[q], k = j.name, n = Wd(j.value), m = ob(k), (o = Da.test(m)) && (k = k.replace(Te, "").substr(8).replace(/_(.)/g, function(a, b) {
                  return b.toUpperCase()
                }));
                var x = m.match(Ea);
                x && da(x[1]) && (s = k, w = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6)), l = ob(k.toLowerCase()), i[l] = k, (o || !c.hasOwnProperty(l)) && (c[l] = n, Ra(a, l) && (c[l] = !0)), oa(a, b, n, l, o), ca(b, l, "A", d, e, s, w)
              }
              if (g = a.className, t(g) && (g = g.animVal), v(g) && "" !== g)
                for (; f = u.exec(g);) l = ob(f[2]), ca(b, l, "C", d, e) && (c[l] = Wd(f[3])), g = g.substr(f.index + f[0].length);
              break;
            case ee:
              if (11 === Id)
                for (; a.parentNode && a.nextSibling && a.nextSibling.nodeType === ee;) a.nodeValue = a.nodeValue + a.nextSibling.nodeValue, a.parentNode.removeChild(a.nextSibling);
              ka(b, a.nodeValue);
              break;
            case fe:
              V(a, b, c, d, e)
        ...
        function W(a, b, c) {
          ...
          if (b && a.hasAttribute && a.hasAttribute(b)) {
            do {
              if (!a) throw Re("uterdir", "Unterminated attribute, found '{0}' but no matching '{1}' found.", b, c);
              a.nodeType == ce && (a.hasAttribute(b) && e++, a.hasAttribute(c) && e--), d.push(a), a = a.nextSibling
            } while (e > 0)
          } else d.push(a);
          return Jd(d)
        }
        ...
        function $(a, b, c, f, g, h, i, k, l) {
          ...
          function n(a, f, g, h, l) {
            function m(a, b, c, d) {
              ...
              if (r(f)) throw Re("noslot", 'No parent directive that requires a transclusion with slot name "{0}". Element: {1}', d, Y(C))
            }
            var n, o, p, q, s, u, v, C, D, E;
            b === g ? (D = c, C = c.$$element) : (C = Jd(g), D = new I(C, c)), s = f, z ? q = f.$new(!0) : w && (s = f.$parent), l && (v = m, v.$$boundTransclude = l, v.isSlotFilled = function(a) {
              return !!l.$$slots[a]
            ...
            for (d(x, function(a, b) {
                var c = a.require;
                a.bindToController && !Ud(c) && t(c) && j(u[b].instance, _(b, c, C, u))
              }), d(u, function(a) {
                var b = a.instance;
          ...
          l = l || {};
          for (var o, p, q, s, u, v = -Number.MAX_VALUE, w = l.newScopeDirective, x = l.controllerDirectives, z = l.newIsolateScopeDirective, A = l.templateDirective, C = l.nonTlbTranscludeDirective, D = !1, E = !1, F = l.hasElementTranscludeDirective, G = c.$$element = Jd(b), H = h, J = f, K = !1, M = !1, O = 0, P = a.length; P > O; O++) {
            o = a[O];
            var S = o.$$start,
              T = o.$$end;
            if (S && (G = W(b, S, T)), q = void 0, v > o.priority) break;
            if ((u = o.scope) && (o.templateUrl || (t(u) ? (ja("new/isolated scope", z || w, o, G), z = o) : ja("new/isolated scope", z, o, G)), w = w || o), p = o.name, !K && (o.replace && (o.templateUrl || o.template) || o.transclude && !o.$$tlb)) {
              for (var V, $ = O + 1; V = a[$++];)
            ...
            if (!o.templateUrl && o.controller && (u = o.controller, x = x || ma(), ja("'" + p + "' controller", x[p], o, G), x[p] = o), u = o.transclude)
              if (D = !0, o.$$tlb || (ja("transclusion", C, o, G), C = o), "element" == u) F = !0, v = o.priority, q = G, G = c.$$element = Jd(N.$$createComment(p, c[p])), b = G[0], pa(g, Q(q), b), q[0].$$parentNode = q[0].parentNode, J = Z(M, q, f, v, H && H.name, {
                nonTlbTranscludeDirective: C
              });
              else {
                var ca = ma();
                if (q = Jd(Ca(b)).contents(), t(u)) {
                  q = [];
                  var da = ma(),
                    fa = ma();
                  d(u, function(a, b) {
                    var c = "?" === a.charAt(0);
                    a = c ? a.substring(1) : a, da[a] = b, ca[b] = null, fa[b] = c
                  }), d(G.contents(), function(a) {
                    var b = da[ob(L(a))];
                    b ? (fa[b] = !0, ca[b] = ca[b] || [], ca[b].push(a)) : q.push(a)
                  }), d(fa, function(a, b) {
                    if (!a) throw Re("reqslot", "Required transclusion slot `{0}` was not filled.", b)
                  });
              ...
              if (E = !0, ja("template", A, o, G), A = o, u = y(o.template) ? o.template(G, c) : o.template, u = Ba(u), o.replace) {
                if (H = o, q = ua(u) ? [] : qb(la(o.templateNamespace, Wd(u))), b = q[0], 1 != q.length || b.nodeType !== ce) throw Re("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", p, "");
                pa(g, G, b);
                var ia = {
                    $attr: {}
                  },
                  ka = U(b, [], ia),
                  na = a.splice(O + 1, a.length - (O + 1));
                (z || w) && ba(ka, z, w), a = a.concat(ka).concat(na), ea(c, ia), P = a.length
              } else G.html(u);
            if (o.templateUrl) E = !0, ja("template", A, o, G), A = o, o.replace && (H = o), n = ga(a.splice(O, a.length - O), G, c, g, D && J, i, k, {
              ...
              y(s) ? m(null, R(oa, s), S, T) : s && m(R(oa, s.pre), R(oa, s.post), S, T)
            } catch (ta) {
              e(ta, Y(G))
            }
        ...
        function _(a, b, c, e) {
          ...
          if (v(b)) {
            ...
            if (!f && !j) throw Re("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", h, a)
          } else if (Ud(b)) {
            f = [];
        ...
        function ga(a, b, c, e, g, h, i, j) {
          ...
          return b.empty(), f(r).then(function(f) {
              var m, u, v, w;
              if (f = Ba(f), p.replace) {
                if (v = ua(f) ? [] : qb(la(s, Wd(f))), m = v[0], 1 != v.length || m.nodeType !== ce) throw Re("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", p.name, r);
                u = {
                  $attr: {}
                }, pa(e, b, m);
                var x = U(m, [], u);
              ...
              for (a.unshift(q), k = $(a, m, c, g, b, p, h, i, j), d(e, function(a, c) {
                ...
                if (!y.$$destroyed) {
                  if (z !== o) {
                    var D = z.className;
                    j.hasElementTranscludeDirective && p.replace || (C = Ca(m)), pa(A, Jd(z), C), K(Jd(C), D)
                  }
        ...
        function ja(a, b, c, d) {
          ...
          if (b) throw Re("multidir", "Multiple directives [{0}{1}, {2}{3}] asking for {4} on: {5}", b.name, e(b.$$moduleName), c.name, e(c.$$moduleName), a, Y(d))
        }
        ...
        function oa(a, b, d, e, f) {
          ...
          var h = c(d, !0, g, f);
          if (h) {
            if ("multiple" === e && "select" === L(a)) throw Re("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", Y(a));
            b.push({
              priority: 100,
              compile: function() {
                return {
                  pre: function(a, b, i) {
                    var j = i.$$observers || (i.$$observers = ma());
                    if (z.test(e)) throw Re("nodomevents", "Interpolations for HTML DOM event attributes are disallowed.  Please use the ng- versions (such as ng-click instead of onclick) instead.");
                    var k = i[e];
        ...
        function sa(a, b, e, f, g) {
          function i(b, c, d) {
            y(e.$onChanges) && c !== d && (ta || (a.$$postDigest(H), ta = []), k || (k = {}, ta.push(j)), k[b] && (d = k[b].previousValue), k[b] = new nb(d, c))
          }
          ...
          return d(f, function(d, f) {
            ...
            switch (t) {
              case "@":
                s || Dd.call(b, r) || (e[f] = b[r] = void 0), b.$observe(r, function(a) {
                  if (v(a) || F(a)) {
                    var b = e[f];
                    i(f, a, b), e[f] = a
                  }
                }), b.$$observers[r].$$scope = a, j = b[r], v(j) ? e[f] = c(j)(a) : F(j) && (e[f] = j), m[f] = new nb(Se, e[f]);
                break;
              case "=":
                if (!Dd.call(b, r)) {
                  if (s) break;
                ...
                k = h(b[r]), p = k.literal ? O : function(a, b) {
                  ...
                  throw j = e[f] = k(a), Re("nonassign", "Expression '{0}' in attribute '{1}' used with directive '{2}' is non-assignable!", b[r], r, g.name)
                }, j = e[f] = k(a);
                var u = function(b) {
              ...
              case "<":
                ...
                k = h(b[r]);
                var w = e[f] = k(a);
                m[f] = new nb(Se, e[f]), q = a.$watch(k, function(a, b) {
                  if (b === a) {
                    if (b === w) return;
                    b = w
                  }
        ...
        I.prototype = {
          ...
          $set: function(a, b, c, f) {
            var g, h = this.$$element[0],
              ...
              j = Sa(a),
              k = a;
            if (i ? (this.$$element.prop(a, b), f = i) : j && (this[j] = b, k = j), this[a] = b, f ? this.$attr[a] = f : (f = this.$attr[a], f || (this.$attr[a] = f = fa(a, "-"))), g = L(this.$$element), "a" === g && ("href" === a || "xlinkHref" === a) || "img" === g && "src" === a) this[a] = b = G(b, "src" === a);
            else if ("img" === g && "srcset" === a && s(b)) {
              for (var l = "", m = Wd(b), n = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, o = /\s/.test(m) ? n : /(,)/, p = m.split(o), q = Math.floor(p.length / 2), t = 0; q > t; t++) {
                var u = 2 * t;
                l += G(Wd(p[u]), !0), l += " " + Wd(p[u + 1])
              }
              var v = Wd(p[2 * t]).split(/\s/);
              l += G(Wd(v[0]), !0), 2 === v.length && (l += " " + Wd(v[1])), this[a] = b = l
            }
            c !== !1 && (null === b || r(b) ? this.$$element.removeAttr(f) : va.test(f) ? this.$$element.attr(f, b) : J(this.$$element[0], f, b));
        ...
        return N.$$addBindingInfo = C ? function(a, b) {
          ...
          Ud(b) ? c = c.concat(b) : c.push(b), a.data("$binding", c)
      ...
      this.has = function(b) {
        ...
        return function(b, g, h, i) {
          ...
          if (h = h === !0, i && v(i) && (n = i), v(b)) {
            if (l = b.match(Ve), !l) throw Ue("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", b);
            m = l[1], n = n || l[3], b = a.hasOwnProperty(m) ? a[m] : ka(g.$scope, m, !0) || (c ? ka(e, m, !0) : void 0), ia(b, m, !0)
          }
          if (h) {
      ...
      this.$get = function() {
        return function(a) {
          ...
          return e(a, function(a, c) {
            null === a || r(a) || (Ud(a) ? d(a, function(a) {
              b.push(ba(c) + "=" + ba(vb(a)))
            }) : b.push(ba(c) + "=" + ba(vb(a))))
          }), b.join("&")
        }
    ...
    function xb() {
      this.$get = function() {
        return function(a) {
          function b(a, f, g) {
            null === a || r(a) || (Ud(a) ? d(a, function(a, c) {
              b(a, f + "[" + (t(a) ? c : "") + "]")
    ...
    function Ab(a) {
      ...
      return v(a) ? d(a.split("\n"), function(a) {
        c = a.indexOf(":"), b(Ed(Wd(a.substr(0, c))), Wd(a.substr(c + 1)))
    ...
    function Eb() {
      ...
      this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(g, h, i, k, l, m) {
        function n(c) {
          ...
          function i(b) {
            var c = b.headers,
              e = Cb(b.data, Bb(c), void 0, b.transformRequest);
          ...
          function k(a) {
            var b = j({}, a);
            return b.data = Cb(a.data, a.headers, a.status, n.transformResponse), Db(a.status) ? b : l.reject(b)
          }
          ...
          n.headers = h(c), n.method = Fd(n.method), n.paramSerializer = v(n.paramSerializer) ? m.get(n.paramSerializer) : n.paramSerializer;
          var o = [],
            p = [],
            s = l.when(n);
          return d(x, function(a) {
            ...
            return ia(a, "fn"), s.then(function(b) {
              a(b.data, b.status, b.headers, n)
            }), s
          }, s.error = function(a) {
            return ia(a, "fn"), s.then(null, function(b) {
              a(b.data, b.status, b.headers, n)
            }), s
          }) : (s.success = bf("success"), s.error = bf("error")), s
        }
        ...
        function q(b, e) {
          ...
          function i(a, b, d, e) {
            ...
            p && (Db(a) ? p.put(z, [a, b, Ab(d), e]) : p.remove(z)), c ? k.$applyAsync(f) : (f(), k.$$phase || k.$apply())
          }

          function j(a, c, d, e) {
            c = c >= -1 ? c : 0, (Db(c) ? v.resolve : v.reject)({
              data: a,
              status: c,
              headers: Bb(d),
              config: b,
          ...
          if (n.pendingRequests.push(b), x.then(o, o), !b.cache && !a.cache || b.cache === !1 || "GET" !== b.method && "JSONP" !== b.method || (p = t(b.cache) ? b.cache : t(a.cache) ? a.cache : w), p && (q = p.get(z), s(q) ? G(q) ? q.then(m, m) : Ud(q) ? j(q[1], q[0], oa(q[2]), q[3]) : j(q, 200, {}, "OK") : p.put(z, x)), r(q)) {
    ...
    function Hb(a, b, c, e, f) {
      function g(a, b, c) {
        ...
        return d.type = "text/javascript", d.src = a, d.async = !0, g = function(a) {
          me(d, "load", g), me(d, "error", g), f.body.removeChild(d), d = null;
          var h = -1,
            i = "unknown";
          a && ("load" !== a.type || e.wasCalled(b) || (a = {
            type: "error"
          }), i = a.type, h = "error" === a.type ? 404 : 200), c && c(h, i)
        }, le(d, "load", g), le(d, "error", g), f.body.appendChild(d), g
      }
      return function(f, h, i, j, k, l, m, o, p, q) {
        ...
        if (a.$$incOutstandingRequestCount(), h = h || a.url(), "jsonp" === Ed(f)) var v = e.createCallback(h),
    ...
    function Ib() {
      ...
      this.startSymbol = function(b) {
        ...
        function k(f, k, n, o) {
          ...
          if (n && D.length > 1 && cf.throwNoconcat(f), !k || A.length) {
            var F = function(a) {
    ...
    function Tb(a, b, c) {
      this.$$html5 = !0, c = c || "", Lb(a, this), this.$$parse = function(a) {
        var c = Ob(b, a);
        if (!v(c)) throw gf("ipthprfx", 'Invalid url "{0}", missing path prefix "{1}".', a, b);
        Mb(c, this), this.$$path || (this.$$path = "/"), this.$$compose()
      }, this.$$compose = function() {
        var a = _(this.$$search),
          c = this.$$hash ? "#" + aa(this.$$hash) : "";
        this.$$url = Kb(this.$$path) + (a ? "?" + a : "") + c, this.$$absUrl = b + this.$$url.substr(1)
    ...
    function Ub(a, b, c) {
      Lb(a, this), this.$$parse = function(d) {
        function e(a, b, c) {
          var d, e = /^\/[A-Z]:(\/.*)/;
          return Nb(b, c) && (b = b.replace(c, "")), e.exec(b) ? a : (d = e.exec(a), d ? d[1] : a)
        }
        var f, g = Ob(a, d) || Ob(b, d);
        r(g) || "#" !== g.charAt(0) ? this.$$html5 ? f = g : (f = "", r(g) && (a = d, this.replace())) : (f = Ob(c, g), r(f) && (f = g)), Mb(f, this), this.$$path = e(this.$$path, f, a), this.$$compose()
      }, this.$$compose = function() {
        var b = _(this.$$search),
          d = this.$$hash ? "#" + aa(this.$$hash) : "";
        this.$$url = Kb(this.$$path) + (b ? "?" + b : "") + d, this.$$absUrl = a + (this.$$url ? c + this.$$url : "")
    ...
    function Vb(a, b, c) {
      this.$$html5 = !0, Ub.apply(this, arguments), this.$$parseLinkUrl = function(d, e) {
        ...
        var b = _(this.$$search),
          d = this.$$hash ? "#" + aa(this.$$hash) : "";
        this.$$url = Kb(this.$$path) + (b ? "?" + b : "") + d, this.$$absUrl = a + c + this.$$url
      }
    }
      ...
      this.hashPrefix = function(b) {
        ...
        f.on("click", function(a) {
          if (b.rewriteLinks && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 != a.which && 2 != a.button) {
            for (var e = Jd(a.target);
              "a" !== L(e[0]);)
              if (e[0] === f[0] || !(e = e.parent())[0]) return;
            var h = e.prop("href"),
              i = e.attr("href") || e.attr("xlink:href");
            t(h) && "[object SVGAnimatedString]" === h.toString() && (h = Fc(h.animVal).href), p.test(h) || !h || e.attr("target") || a.isDefaultPrevented() || j.$$parseLinkUrl(h, i) && (a.preventDefault(), j.absUrl() != d.url() && (c.$apply(), g.ipnrm_angular["ff-684208-preventDefault"] = !0))
          }
      ...
      switch (a.type) {
        ...
        case qf.ObjectExpression:
          c = !0, e = [], d(a.properties, function(a) {
            gc(a.value, b), c = c && a.value.constant && !a.computed, a.value.constant || e.push.apply(e, a.value.toWatch)
          }), a.constant = c, a.toWatch = e;
          break;
    ...
    function vc() {
      ...
      this.digestTtl = function(a) {
        ...
        function m(a) {
          9 === Id && (a.$$childHead && m(a.$$childHead), a.$$nextSibling && m(a.$$nextSibling)), a.$parent = a.$$nextSibling = a.$$prevSibling = a.$$childHead = a.$$childTail = a.$root = a.$$watchers = null
        }
              ...
              if (!r(f)) {
                if (t(f))
                  if (c(f)) {
                    ...
                    g !== o && (g = o = {}, q = 0, l++), b = 0;
                    for (d in f) Dd.call(f, d) && (b++, h = f[d], i = g[d], d in g ? (e = i !== i && h !== h, e || i === h || (l++, g[d] = h)) : (q++, g[d] = h, l++));
                    if (q > b) {
                      l++;
                      for (d in g) Dd.call(f, d) || (q--, delete g[d])
                    }
                  }
                else g !== f && (g = f, l++);
                return l
              ...
              if (p ? (p = !1, b(f, f, i)) : b(f, h, i), k)
                if (t(f))
                  if (c(f)) {
                    ...
                    h = {};
                    for (var d in f) Dd.call(f, d) && (h[d] = f[d])
                  }
              else h = f
            }
            d.$stateful = !0;
    ...
    function xc(a) {
      ...
      if (v(a)) {
        ...
        return a = Xd(a).replace("\\*\\*", ".*").replace("\\*", "[^:/.?&;]*"), new RegExp("^" + a + "$")
      }
    ...
    function Ac() {
      ...
      this.enabled = function(b) {
        ...
        if (a && 8 > Id) throw tf("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
        var e = oa(uf);
    ...
    function Bc() {
      this.$get = ["$window", "$document", function(a, b) {
        var c, d, e = {},
          ...
          h = l((/android (\d+)/.exec(Ed((a.navigator || {}).userAgent)) || [])[1]),
    ...
    function Cc() {
      ...
      this.httpOptions = function(b) {
        ...
        function f(g, h) {
          ...
          return Ud(k) ? k = k.filter(function(a) {
            return a !== yb
          }) : k === yb && (k = null), c.get(g, j({
            cache: b,
            transformResponse: k
          }, a))["finally"](function() {
    ...
    function Fc(a) {
      var b = a;
      return Id && (wf.setAttribute("href", b), b = wf.href), wf.setAttribute("href", b), {
        href: wf.href,
    ...
    function Kc(a) {
      ...
      }], b("currency", Pc), b("date", cd), b("filter", Lc), b("json", dd), b("limitTo", ed), b("lowercase", Ef), b("number", Qc), b("orderBy", gd), b("uppercase", Ff)
    }
    ...
    function Mc(a, b, c, d) {
      ...
      return b === !0 ? b = O : y(b) || (b = function(a, b) {
        return r(a) ? !1 : null === a || null === b ? a === b : t(b) || t(a) && !q(a) ? !1 : (a = Ed("" + a), b = Ed("" + b), -1 !== a.indexOf(b))
      }), e = function(e) {
        return f && !t(e) ? Nc(e, a[c], b, c, !1) : Nc(e, a, b, c, d)
      }
    }
    ...
    function Nc(a, b, c, d, e, f) {
      var g = Oc(a),
        h = Oc(b);
      if ("string" === h && "!" === b.charAt(0)) return !Nc(a, b.substring(1), c, d, e);
      if (Ud(a)) return a.some(function(a) {
        return Nc(a, b, c, d, e)
      });
      switch (g) {
        case "object":
          ...
          if (e) {
            for (i in a)
              if ("$" !== i.charAt(0) && Nc(a[i], b, c, d, !0)) return !0;
    ...
    function cd(a) {
      ...
      return function(c, e, f) {
        ...
        for (; e;) h = Cf.exec(e), h ? (j = P(j, h, 1), e = j.pop()) : (j.push(e), e = null);
    ...
    function ed() {
      return function(a, b, d) {
        return b = Math.abs(Number(b)) === 1 / 0 ? Number(b) : l(b), isNaN(b) ? a : (w(a) && (a = a.toString()), c(a) ? (d = !d || isNaN(d) ? 0 : l(d), d = 0 > d ? Math.max(0, a.length + d) : d, b >= 0 ? fd(a, d, d + b) : 0 === d ? fd(a, b, a.length) : fd(a, Math.max(0, d + b), d)) : a)
      }
    }
    ...
    function jd(a, b, c, e, f) {
      ...
      g.$error = {}, g.$$success = {}, g.$pending = void 0, g.$name = f(b.name || b.ngForm || "")(c), g.$dirty = !1, g.$pristine = !0, g.$valid = !0, g.$invalid = !1, g.$submitted = !1, g.$$parentForm = If, g.$rollbackViewValue = function() {
        ...
        ja(a.$name, "input"), h.push(a), a.$name && (g[a.$name] = a), a.$$parentForm = g
    ...
    function md(a, b, c, d, e, f) {
      ...
      var i, j = function(a) {
        if (i && (f.defer.cancel(i), i = null), !h) {
          var e = b.val(),
            j = a && a.type;
          "password" === g || c.ngTrim && "false" === c.ngTrim || (e = Wd(e)), (d.$viewValue !== e || "" === e && d.$$hasNativeValidators) && d.$setViewValue(e, j)
        }
      };
    ...
    function rd(a, b, c, d, e, f) {
      if (qd(a, b, c, d), md(a, b, c, d, e, f), d.$$parserName = "number", d.$parsers.push(function(a) {
    ...
    function sd(a, b, c, d, e, f) {
      md(a, b, c, d, e, f), kd(d), d.$$parserName = "url", d.$validators.url = function(a, b) {
        var c = a || b;
    ...
    function td(a, b, c, d, e, f) {
      md(a, b, c, d, e, f), kd(d), d.$$parserName = "email", d.$validators.email = function(a, b) {
        var c = a || b;
    ...
    function yd(a) {
      function b(a, b, h) {
        r(b) ? c("$pending", a, h) : d("$pending", a, h), F(b) ? b ? (k(g.$error, a, h), j(g.$$success, a, h)) : (j(g.$error, a, h), k(g.$$success, a, h)) : (k(g.$error, a, h), k(g.$$success, a, h)), g.$pending ? (e(wg, !0), g.$valid = g.$invalid = void 0, f("", null)) : (e(wg, !1), g.$valid = zd(g.$error), g.$invalid = !g.$valid, f("", g.$valid));
        var i;
      ...
      function f(a, b) {
        a = a ? "-" + fa(a, "-") : "", e(qg + a, b === !0), e(rg + a, b === !1)
      }
      var g = a.ctrl,
        h = a.$element,
        i = {},
    ...
    var Ud = Array.isArray,
      ...
      Zd = function() {
        ...
        var b, c, d, e, f = _d.length;
        for (c = 0; f > c; ++c)
          if (d = _d[c], b = a.document.querySelector("[" + d.replace(":", "\\:") + "jq]")) {
    ...
    var we = a.Node.prototype.contains || function(a) {
      ...
      xe = Ba.prototype = {
        ready: function(b) {
          ...
          var d = !1;
          "complete" === a.document.readyState ? a.setTimeout(c) : (this.on("DOMContentLoaded", c), Ba(a).on("load", c))
        },
        toString: function() {
          var a = [];
    ...
    d({
      ...
      inheritedData: Na,
      scope: function(a) {
        return Jd.data(a, "$scope") || Na(a.parentNode || a, ["$isolateScope", "$scope"])
      },
      isolateScope: function(a) {
        return Jd.data(a, "$isolateScope") || Jd.data(a, "$isolateScopeNoTemplate")
      },
      controller: Ma,
      injector: function(a) {
      ...
      hasClass: Ia,
      css: function(a, b, c) {
        return b = ta(b), s(c) ? void(a.style[b] = c) : a.style[b]
      },
      attr: function(a, b, c) {
        var d = a.nodeType;
        if (d !== ee && d !== de && d !== fe) {
      ...
      text: function() {
        function a(a, b) {
          if (r(b)) {
            var c = a.nodeType;
            return c === ce || c === ee ? a.textContent : ""
          }
          a.textContent = b
        }
        return a.$dv = "", a
      ...
      html: function(a, b) {
        return r(b) ? a.innerHTML : (Da(a, !0), void(a.innerHTML = b))
      },
      empty: Oa
    }, function(a, b) {
      Ba.prototype[b] = function(b, c) {
        var d, e, f = this.length;
        if (a !== Oa && r(2 == a.length && a !== Ia && a !== Ma ? b : c)) {
          if (t(b)) {
            for (d = 0; f > d; d++)
              if (a === Ha) a(this[d], b);
              else
      ...
      removeData: Fa,
      on: function(a, b, c, d) {
        if (s(d)) throw qe("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
        if (va(a)) {
          var e = Ga(a, !0),
            f = e.events,
            g = e.handle;
          ...
          for (var h = b.indexOf(" ") >= 0 ? b.split(" ") : [b], i = h.length, j = function(b, d, e) {
              var h = f[b];
              h || (h = f[b] = [], h.specialHandlerWrapper = d, "$destroy" === b || e || le(a, b, g)), h.push(c)
            }; i--;) b = h[i], pe[b] ? (j(pe[b], Va), j(b, void 0, !0)) : j(b)
        }
      },
      off: Ea,
      one: function(a, b, c) {
        a = Jd(a), a.on(b, function d() {
          a.off(b, c), a.off(b, d)
        }), a.on(b, c)
      },
      replaceWith: function(a, b) {
        var c, e = a.parentNode;
        Da(a), d(new Ba(b), function(b) {
      ...
      triggerHandler: function(a, b, c) {
        ...
        l && (e = {
          ...
          type: h,
          target: a
        }, b.type && (e = j(e, b)), f = oa(l), g = c ? [e].concat(c) : [e], d(f, function(b) {
          e.isImmediatePropagationStopped() || b.apply(a, g)
        }))
      }
    }, function(a, b) {
      Ba.prototype[b] = function(b, c, d) {
        for (var e, f = 0, g = this.length; g > f; f++) r(e) ? (e = a(this[f], b, c, d), s(e) && (e = Jd(e))) : La(e, a(this[f], b, c, d));
        return s(e) ? e : this
    ...
    var Ie = b("$animate"),
      ...
      Me = function() {
        ...
        this.$get = ["$$AnimateRunner", "$rootScope", function(c, e) {
          function f(a, b, c) {
            var e = !1;
            return b && (b = v(b) ? b.split(" ") : Ud(b) ? b : [], d(b, function(b) {
              b && (e = !0, a[b] = c)
            })), e
          }
      ...
      Ne = ["$provide", function(a) {
        ...
        this.$$registeredAnimations = Object.create(null), this.register = function(c, d) {
          if (c && "." !== c.charAt(0)) throw Ie("notcsel", "Expecting class selector starting with '.' got '{0}'.", c);
          var e = c + "-animation";
          ...
          if (1 === arguments.length && (this.$$classNameFilter = a instanceof RegExp ? a : null, this.$$classNameFilter)) {
            var b = new RegExp("(\\s+|\\/)" + Ke + "(\\s+|\\/)");
            if (b.test(this.$$classNameFilter.toString())) throw Ie("nongcls", '$animateProvider.classNameFilter(regex) prohibits accepting a regex value which matches/contains the "{0}" CSS class.', Ke)
          }
          ...
          return {
            ...
            enter: function(c, d, e, f) {
              return d = d && Jd(d), e = e && Jd(e), d = d || e.parent(), b(c, d, e), a.push(c, "enter", gb(f))
            },
            move: function(c, d, e, f) {
              return d = d && Jd(d), e = e && Jd(e), d = d || e.parent(), b(c, d, e), a.push(c, "move", gb(f))
            },
            leave: function(b, c) {
            ...
            setClass: function(b, c, d, e) {
              return e = gb(e), e.addClass = db(e.addClass, c), e.removeClass = db(e.removeClass, d), a.push(b, "setClass", e)
            },
            animate: function(b, c, d, e, f) {
              return f = gb(f), f.from = f.from ? j(f.from, c) : c, f.to = f.to ? j(f.to, d) : d, e = e || "ng-inline-animate", f.tempClasses = db(f.tempClasses, e), a.push(b, "animate", f)
            }
          }
        }]
      }],
      ...
      Re = b("$compile"),
      Se = new lb;
    mb.$inject = ["$provide", "$$sanitizeUriProvider"], nb.prototype.isFirstChange = function() {
    ...
    var Te = /^((?:x|data)[\:\-_])/i,
      ...
      We = function() {
        this.$get = ["$document", function(a) {
          return function(b) {
            return b ? !b.nodeType && b instanceof Jd && (b = b[0]) : b = a[0].body, b.offsetWidth + 1
          }
        }]
      },
      Xe = "application/json",
    ...
    d([Vb, Ub, Tb], function(a) {
      a.prototype = Object.create(hf), a.prototype.state = function(b) {
        ...
        if (a !== Tb || !this.$$html5) throw gf("nostate", "History API state support is available only in HTML5 mode and only in browsers supporting HTML5 History API");
      ...
      recurse: function(a, b, c, e, f, g) {
        ...
        switch (a.type) {
          ...
          case qf.ConditionalExpression:
            ...
            break;
          case qf.Identifier:
            b = b || this.nextId(), c && (c.context = "inputs" === m.stage ? "s" : this.assign(this.nextId(), this.getHasOwnProperty("l", a.name) + "?l:s"), c.computed = !1, c.name = a.name), $b(a.name), m.if_("inputs" === m.stage || m.not(m.getHasOwnProperty("l", a.name)), function() {
              ...
              }, b && m.lazyAssign(b, m.nonComputedMember("l", a.name))), (m.state.expensiveChecks || oc(a.name)) && m.addEnsureSafeObject(b),
              e(b);
            break;
          case qf.MemberExpression:
          ...
          case qf.CallExpression:
            ...
            break;
          case qf.AssignmentExpression:
            if (i = this.nextId(), h = {}, !ic(a.left)) throw jf("lval", "Trying to assign a value to a non l-value");
    ...
    var rf = function(a, b, c) {
      this.lexer = a, this.$filter = b, this.options = c, this.ast = new qf(a, c), this.astCompiler = c.csp ? new nc(this.ast, b) : new mc(this.ast, b)
    };
    rf.prototype = {
      constructor: rf,
      parse: function(a) {
        ...
        compile: function(a, b) {
          return b.href || b.xlinkHref ? void 0 : function(a, b) {
            if ("a" === b[0].nodeName.toLowerCase()) {
              var c = "[object SVGAnimatedString]" === Pd.call(b.prop("href")) ? "xlink:href" : "href";
      ...
      Hf[b] = function() {
        return {
          ...
          link: function(c, d, e) {
            var f = a,
              g = a;
            "href" === a && "[object SVGAnimatedString]" === Pd.call(d.prop("href")) && (g = "xlinkHref", e.$attr[g] = "xlink:href", f = null), e.$observe(b, function(b) {
              return b ? (e.$set(g, b), void(Id && f && d.prop(f, e[g]))) : void("href" === a && e.$set(g, null))
            })
          }
        }
      }
    ...
    var Kf = function(a) {
              ...
              return {
                pre: function(a, c, e, g) {
                  ...
                  if (!("action" in e)) {
                    ...
                    le(c[0], "submit", i), c.on("$destroy", function() {
                      b(function() {
                        me(c[0], "submit", i)
                      }, 0, !1)
                    })
      ...
      Pf = /^(?=.{1,254}$)(?=.{1,64}@)[-!#$%&'*+\/0-9=?A-Z^_`a-z{|}~]+(\.[-!#$%&'*+\/0-9=?A-Z^_`a-z{|}~]+)*@[A-Za-z0-9]([A-Za-z0-9-]{0,61}[A-Za-z0-9])?(\.[A-Za-z0-9]([A-Za-z0-9-]{0,61}[A-Za-z0-9])?)*$/,
      Qf = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/,
      Rf = /^(\d{4,})-(\d{2})-(\d{2})$/,
    ...
    var Yf = {
        text: ld,
        date: pd("date", Rf, od(Rf, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
        "datetime-local": pd("datetimelocal", Sf, od(Sf, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"),
        time: pd("time", Vf, od(Vf, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
        ...
        return {
          ...
          link: {
            pre: function(e, f, g, h) {
              h[0] && (Yf[Ed(g.type)] || Yf.text)(e, f, g, h[0], b, a, c, d)
            }
          }
        }
      }],
    ...
    var lg = ["$animate", "$compile", function(a, b) {
        return {
          ...
          link: function(c, d, e, f, g) {
            ...
            c.$watch(e.ngIf, function(c) {
              ...
              }) : (j && (j.remove(), j = null), i && (i.$destroy(), i = null), h && (j = la(h.clone), a.leave(j).then(function() {
                j = null
              }), h = null))
            })
          }
      ...
      ng = ["$compile", function(b) {
        return {
          ...
          link: function(c, d, e, f) {
            return Pd.call(d[0]).match(/SVG/) ? (d.empty(), void b(ya(f.template, a.document).childNodes)(c, function(a) {
              d.append(a)
            }, {
      ...
      Ag = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, b, c, e, f, g, h, i, j, k) {
        ...
        this.$$setOptions = function(a) {
          ...
          } else if (!m.assign) throw zg("nonassign", "Expression '{0}' is non-assignable. Element: {1}", c.ngModel, Y(e))
      ...
      Dg = function() {
        return {
          ...
          controller: ["$scope", "$attrs", function(a, b) {
            var c = this;
            this.$options = N(a.$eval(b.ngModelOptions)), s(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = Wd(this.$options.updateOn.replace(Cg, function() {
      ...
      Hg = ["$compile", "$document", "$parse", function(b, e, f) {
        function g(a, b, d) {
          ...
          var h = a.match(Gg);
          if (!h) throw Fg("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", a, Y(b));
          var i = h[5] || h[7],
            j = h[6],
            k = / as /.test(h[0]) && h[1],
            l = h[9],
            ...
            getOptions: function() {
              ...
              return {
                ...
                getViewValueFromOption: function(a) {
                  return l ? Sd.copy(a.viewValue) : a.viewValue
                }
              }
            }
          }
        ...
        function h(a, c, f, h) {
          ...
          function m() {
            ...
            if (x)
              for (var b = x.items.length - 1; b >= 0; b--) {
                var d = x.items[b];
                Pa(s(d.group) ? d.element.parentNode : d.element)
              }
            x = y.getOptions();
            var e = {};
          ...
          q ? (p.$isEmpty = function(a) {
            ...
            return Ud(p.$viewValue) ? p.$viewValue.map(function(a) {
            ...
            p.$render()
          })), v ? (n.remove(), b(n)(a), n.removeClass("ng-scope")) : n = Jd(i.cloneNode(!1)), c.empty(), m(), a.$watchCollection(y.getWatchables, m)
        }
              ...
              function(a, b, f, l, o) {
                ...
                a.$watchCollection(q, function(f) {
                  ...
                  if (r && (a[r] = f), c(f)) D = f, C = w || x;
                    ...
                    C = w || y, D = [];
                    for (var J in f) Dd.call(f, J) && "$" !== J.charAt(0) && D.push(J)
                  }
                  for (v = D.length, F = new Array(v), l = 0; v > l; l++)
                    ...
                    if (E = p[K], G = la(E.clone), e.leave(G), G[0].parentNode)
                  ...
                  for (l = 0; v > l; l++)
                    if (z = f === D ? l : D[l], A = f[z], E = F[l], E.scope) {
                      ...
                      j(E) != s && e.move(la(E.clone), null, H), H = k(E), i(E.scope, l, t, A, u, z, v)
                    } else o(function(a, b) {
                      E.scope = b;
                      var c = n.cloneNode(!1);
          ...
          compile: function(b) {
            ...
            return b.empty(),
              function(a, b, d, e, f) {
                ...
                if (!f) throw Sg("orphan", "Illegal use of ngTransclude directive in the template! No parent directive that requires a transclusion found. Element: {0}", Y(b));
      ...
      Wg = ["$element", "$scope", function(b, c) {
        var d = this,
          e = new Ya;
        d.ngModelCtrl = Vg, d.unknownOption = Jd(a.document.createElement("option")), d.renderUnknownOption = function(a) {
          var c = "? " + Xa(a) + " ?";
          ...
          if (b[0].nodeType !== fe) {
            ja(a, '"option value"'), "" === a && (d.emptyOption = b);
            var c = e.get(a) || 0;
        ...
        function a(a, b, c, e) {
          ...
          if (f) {
            ...
            if (g.ngModelCtrl = f, b.on("change", function() {
              ...
              var h, i = NaN;
              a.$watch(function() {
                i !== f.$viewValue || O(h, f.$viewValue) || (h = oa(f.$viewValue), f.$render()), i = f.$viewValue
    ...
    return a.ipnrm_angular.bootstrap ? void(a.console && console.log("WARNING: Tried to load angular more than once.")) : (ga(), ra(Sd), void Sd.module("ngLocale", [], ["$provide", function(a) {
      function b(a) {
        a += "";
        var b = a.indexOf(".");
    ...
    fn: {
      ...
      tabPanelItemClick: function(a) {
        if (!a.appData.config.tabPanel[a.id].isActive) {
          ...
          a.appData.config.tabPanel[a.id].isActive = !0, a.$root.safeApply()
        }
      },
      selectPopoverShowClass: function(a) {
        ...
        a.modal.fn.show(a, a.path + "assets/views/modal-getshowclass.html", b, a.fn.selectPopoverClassCallback).then(function(c) {
          a.modal.fn.close(a, b.id), "close" != c && c && (a.config.popoverShowClass = b.selectedClass)
        })
      },
      selectPopoverHideClass: function(a) {
        ...
        a.modal.fn.show(a, a.path + "assets/views/modal-gethideclass.html", b, a.fn.selectPopoverClassCallback).then(function(c) {
          a.modal.fn.close(a, b.id), "close" != c && c && (a.config.popoverHideClass = b.selectedClass)
        })
      },
      selectPopoverClassCallback: function() {
        ...
        jQuery(".ipnrm-ui-modal-btn[data-fx-name]").on("click", function(a) {
          var b = jQuery(a.target),
            c = b.data("fx-name");
          b.removeClass(c).addClass(c)
        }), jQuery(".ipnrm-ui-modal-btn[data-fx-name]").on(a(), function(a) {
          var b = jQuery(a.target),
            c = b.data("fx-name");
      ...
      selectImage: function(a, b) {
        var c = {
          ...
          d = function() {
            ...
            let panorama_id = params.get("id");
            let path = `get-files.php?user_id=${user_id}&id=${panorama_id}`;
            a.srv.$http.get(a.path + path).success(function(a) {
              c.files = a
            })
          };
        a.modal.fn.show(a, a.path + "assets/views/modal-select-file.html", c, d).then(function(b) {
          a.modal.fn.close(a, c.id), "close" != b && b && c.selectedFile && a.fn.setImageUrl(a, c.imageObj, c.selectedFile.filename, !1)
        })
      },
      getImageUrl: function(a, b) {
        if (b) {
          var c = "";
          return b.isCustom ? c = b.url : b.url && b.url.length > 0 && (c = a.uploadUrl + "/" + b.url), c
        }
      },
      setImageUrlConfirm: function(a, b) {
        ...
        a.modal.fn.show(a, a.path + "assets/views/modal-set-url.html", c).then(function(d) {
          a.modal.fn.close(a, c.id), "close" != d && d && a.fn.setImageUrl(a, b, c.url, !0)
        })
      },
      ...
      getConfig: function(a, b, c) {
        var d = {};
        if (d.theme = b.theme, b.imagePreview.isActive && (d.imagePreview = a.fn.getImageUrl(a, b.imagePreview)), d.autoLoad = b.autoLoad, d.autoRotate = b.autoRotate, d.autoRotateSpeed = b.autoRotateSpeed, d.autoRotateInactivityDelay = b.autoRotateInactivityDelay, d.mouseWheelPreventDefault = b.mouseWheelPreventDefault, d.mouseWheelRotate = b.mouseWheelRotate, d.mouseWheelRotateCoef = b.mouseWheelRotateCoef, d.mouseWheelZoom = b.mouseWheelZoom, d.mouseWheelZoomCoef = b.mouseWheelZoomCoef, d.hoverGrab = b.hoverGrab, d.hoverGrabYawCoef = b.hoverGrabYawCoef, d.hoverGrabPitchCoef = b.hoverGrabPitchCoef, d.grab = b.grab, d.grabCoef = b.grabCoef, d.pinchZoom = b.pinchZoom, d.pinchZoomCoef = b.pinchZoomCoef, d.showControlsOnHover = b.showControlsOnHover, d.showSceneThumbsCtrl = b.showSceneThumbsCtrl, d.showSceneMenuCtrl = b.showSceneMenuCtrl, d.showSceneNextPrevCtrl = b.showSceneNextPrevCtrl, d.showShareCtrl = b.showShareCtrl, d.showZoomCtrl = b.showZoomCtrl, d.showFullscreenCtrl = b.showFullscreenCtrl, d.showAutoRotateCtrl = b.showAutoRotateCtrl, d.sceneThumbsVertical = b.sceneThumbsVertical, d.sceneThumbsStatic = b.sceneThumbsStatic, d.title = b.title, d.compass = b.compass, d.keyboardNav = b.keyboardNav, d.keyboardZoom = b.keyboardZoom, d.sceneNextPrevLoop = b.sceneNextPrevLoop, d.popover = b.popover, b.popover) {
          var e = b.popoverTemplate;
          e && (e = e.replace(/(?:\r\n|\r|\n)/g, ""), e = e.replace(/ /g, "")), '<divclass="ipnrm-popover"><divclass="ipnrm-close"></div><divclass="ipnrm-arrow"></div><divclass="ipnrm-content"></div></div>' != e && (d.popoverTemplate = b.popoverTemplate), d.popoverPlacement = b.popoverPlacement, d.hotSpotBelowPopover = b.hotSpotBelowPopover, d.popoverShowTrigger = (b.popoverShowTriggerHover ? "hover " : "") + (b.popoverShowTriggerClick ? "click " : ""), d.popoverHideTrigger = (b.popoverHideTriggerLeave ? "leave " : "") + (b.popoverHideTriggerClick ? "click " : "") + (b.popoverHideTriggerGrab ? "grab " : "") + (b.popoverHideTriggerManual ? "manual " : ""), d.popoverShowTrigger = d.popoverShowTrigger.trim(), d.popoverHideTrigger = d.popoverHideTrigger.trim(), b.popoverShowClass && b.popoverShowClass.length > 0 && (d.popoverShowClass = b.popoverShowClass), b.popoverHideClass && b.popoverHideClass.length > 0 && (d.popoverHideClass = b.popoverHideClass)
        }
        if (d.mobile = b.mobile, c) return d;
        b.scenes.length > 0 && (d.sceneId = a.fn.getSceneKeyById(b.scenes[0].id), d.sceneFadeDuration = b.sceneFadeDuration, d.sceneBackgroundLoad = b.sceneBackgroundLoad);
        for (var f = {}, g = 0; g < b.scenes.length; g++) {
          var h = b.scenes[g],
            i = {};
          if (h.isVisible) {
            if (i.type = h.config.type, i.cubeTextureCount = h.config.cubeTextureCount, i.sphereWidthSegments = h.config.sphereWidthSegments, i.sphereHeightSegments = h.config.sphereHeightSegments, "cube" == h.config.type && "single" != h.config.cubeTextureCount ? i.image = {
                front: a.fn.getImageUrl(a, h.config.imageFront),
                back: a.fn.getImageUrl(a, h.config.imageBack),
                left: a.fn.getImageUrl(a, h.config.imageLeft),
                right: a.fn.getImageUrl(a, h.config.imageRight),
                top: a.fn.getImageUrl(a, h.config.imageTop),
                bottom: a.fn.getImageUrl(a, h.config.imageBottom)
              } : i.image = a.fn.getImageUrl(a, h.config.imageFront), h.config.thumb && (i.thumb = h.config.thumb, i.thumbImage = a.fn.getImageUrl(a, h.config.thumbImage)), 0 != h.config.yaw && (i.yaw = h.config.yaw), 0 != h.config.pitch && (i.pitch = h.config.pitch), 75 != h.config.zoom && (i.zoom = h.config.zoom), h.config.compassNorthOffset && (i.compassNorthOffset = h.config.compassNorthOffset), i.saveCamera = h.config.saveCamera, h.config.pitchLimits && (i.pitchLimits = h.config.pitchLimits, i.pitchLimitUp = h.config.pitchLimitUp, i.pitchLimitDown = h.config.pitchLimitDown), h.config.yawLimits && (i.yawLimits = h.config.yawLimits, i.yawLimitLeft = h.config.yawLimitLeft, i.yawLimitRight = h.config.yawLimitRight), i.title = h.config.title, i.titleHtml = h.config.titleHtml, i.titleSelector = h.config.titleSelector, h.config.hotspots.length > 0) {
              for (var j = [], k = 0; k < h.config.hotspots.length; k++) {
                var l = h.config.hotspots[k],
                  m = {};
                l.isVisible && (m.title = l.config.title, m.yaw = l.config.yaw, m.pitch = l.config.pitch, "none" != l.config.sceneId && (m.sceneId = l.config.sceneId), m.imageUrl = a.fn.getImageUrl(a, l.config.image), m.imageWidth = l.config.image.width, m.imageHeight = l.config.image.height, m.link = l.config.link, m.linkNewWindow = l.config.linkNewWindow, l.config.popover && (m.popoverHtml = l.config.popoverHtml, m.popoverContent = l.config.popoverContent, m.popoverSelector = l.config.popoverSelector, m.popoverLazyload = l.config.popoverLazyload, m.popoverShow = l.config.popoverShow, "default" != l.config.popoverPlacement && (m.popoverPlacement = l.config.popoverPlacement), l.config.popoverWidth && (m.popoverWidth = l.config.popoverWidth)), l.config.custom && (m.className = l.config.customClassName, m.content = l.config.customContent), l.config.userData && (m.userData = l.config.userData), j.push(m))
              }
              i.hotSpots = j
            }
      ...
      getConfigCode: function(a) {
        var b = '$("#mypanorama").ipanorama(' + JSON.stringify(a.fn.getConfig(a, a.config, !1), null, 2) + ");";
        return b
      },
      getCode: function(a) {
        Swal.showLoading()
        ...
        var dd = a.fn.storage.getConfigObjectForSave(a);
    		var dataJson = ipnrm_angular.toJson(dd);
        ...
        var requestOptions = {
    		  ...
    		  body: JSON.stringify({ data: dataJson, id: idItem }),
    		};

    		fetch('/user/virtuard-360/add/api', requestOptions)
    		...
    		.then(function(data) {
          Swal.close();
    			a.modal.fn.show(a, a.path + "assets/views/modal-getcode.html?id=", b, c).then(function(c) {
      ...
      storage: {
        ...
        loadFromFile: function(a) {
          a.fn.storage.editFile(a, null), jQuery(window).trigger("resize")
        },
        editFile: function(a, b) {
            Swal.showLoading()
            var currentURL = window.location.href;
            var url = new URL(currentURL);
            var idItem = url.searchParams.get("id");
            ...
            // Ubah method menjadi 'GET' dan hapus body
            var requestOptions = {
              method: 'GET',
              headers: {
                'Content-Type': 'application/json',
            ...
            // Ganti URL endpoint sesuai dengan metode GET
            fetch('/user/virtuard-360/add/api/edit?id=' + idItem, requestOptions) // Tambahkan id ke URL
              .then(function (response) {
                if (!response.ok) {
                  Swal.close();
                  throw new Error('Gagal melakukan fetch');
              ...
              .then(function (data) {
                const dataJson = data.data.json_data;
                const jsonDataObj = JSON.parse(dataJson)
                editItem = jsonDataObj;
                a.fn.storage.loadEditJson(a, editItem)
                Swal.close();
              })
              .catch(function (error) {
                console.error('Kesalahan:', error);
        ...
        loadEditJson: function(a, b) {
          var c = ipnrm_angular.fromJson(b);
          a.scene.selected = null, a.hotspot.selected = null, a.config = ipnrm_angular.merge({}, c.config);
      ...
      workspaceSettings: {
        init: function(a, b, c) {
          ...
          if (d) {
            ...
            e.imagePreview.hasOwnProperty("url") || (e.imagePreview = {
              isActive: e.imagePreview,
              isCustom: !1,
              url: e.imagePreviewUrl
            }, delete e.imagePreviewUrl), a.appData.config = ipnrm_angular.merge(a.appData.config, e)
          }
        ...
        updateSettings: function(a) {
          var b = ipnrm_angular.merge({}, a.config),
            ...
            c = ipnrm_angular.merge({}, a.fn.getConfig(a, a.config, !0));
          c = ipnrm_angular.toJson(c), jQuery("#ipnrm-ui-loading").css("display", ""), jQuery.ajax({
            type: "post",
            dataType: "json",
            url: a.ajaxUrl,
            data: {
      ...
      workspace: {
        init: function(a, b, c) {
          function d(a) {
            return a.hasOwnProperty("url") || (a = {
              isCustom: !1,
              url: a
            }), a
          }
          a.appData.configGlobal = ipnrm_angular.copy(a.appData.config);
          var e = jQuery("#ipnrm-ui-meta-ui-cfg").val();
          if (e) {
            var f = ipnrm_angular.fromJson(e);
            f.imagePreview.hasOwnProperty("url") || (f.imagePreview = {
            ...
            for (var g = 0; g < f.scenes.length; g++) {
              var h = f.scenes[g];
              "cube" == h.config.type && "single" != h.config.cubeTextureCount ? (h.config.imageFront = d(h.config.imageFront), h.config.imageBack = d(h.config.imageBack), h.config.imageLeft = d(h.config.imageLeft), h.config.imageRight = d(h.config.imageRight), h.config.imageTop = d(h.config.imageTop), h.config.imageBottom = d(h.config.imageBottom)) : h.config.imageFront = d(h.config.imageFront), h.config.thumbImage = d(h.config.thumbImage);
              for (var i = 0; i < h.config.hotspots.length; i++) {
                var j = h.config.hotspots[i];
                j.config.hasOwnProperty("image") || (j.config.image = {
                  isCustom: !1,
                  url: null,
                  width: null,
                  height: null
                }, j.config.link = null, j.config.linkNewWindow = !1)
              }
            }
            a.appData.config = ipnrm_angular.merge(a.appData.config, f)
          }
          if (e = jQuery("#ipnrm-ui-meta-ui-global-cfg").val()) {
            var f = ipnrm_angular.fromJson(e);
            a.appData.configGlobal = ipnrm_angular.merge(a.appData.configGlobal, f)
          }
          jQuery("#ipnrm-ui-loading").css("display", "none"), jQuery("#post").submit(jQuery.proxy(function() {
            var a = ipnrm_angular.merge({}, this.appData.config),
              a = ipnrm_angular.toJson(a),
              b = ipnrm_angular.merge({}, this.appData.configGlobal),
              b = ipnrm_angular.toJson(b),
              c = ipnrm_angular.merge({}, this.appData.fn.getConfig(this.appData, this.appData.configGlobal, !0)),
              c = ipnrm_angular.toJson(c),
              d = ipnrm_angular.merge({}, this.appData.fn.getConfig(this.appData, this.appData.config, !1)),
              d = ipnrm_angular.toJson(d),
              e = this.appData.config.scenes.length;
            return jQuery("#ipnrm-ui-meta-ui-cfg").val(a), jQuery("#ipnrm-ui-meta-ui-global-cfg").val(b), jQuery("#ipnrm-ui-meta-global-cfg").val(c), jQuery("#ipnrm-ui-meta-panorama-cfg").val(d), jQuery("#ipnrm-ui-meta-panorama-theme").val(this.appData.config.theme), jQuery("#ipnrm-ui-meta-total-scenes").val(e), !0
          }, a)), jQuery(window).on("resize", jQuery.proxy(function() {
            ...
            hotSpotSetup: !1
          }, a.appData.$panorama = jQuery("#ipnrm-ui-canvas"), jQuery("#ipnrm-ui-tab-data").on("click", ".ipnrm-ui-accordion-toggle", function(a) {
            var b = jQuery(this).closest(".ipnrm-ui-accordion");
            b.toggleClass("ipnrm-ui-active")
          }), a.$watchGroup(["appData.scene.selected", "appData.scene.selected.config.type", "appData.scene.selected.config.imageFront.url", "appData.scene.selected.config.imageBack.url", "appData.scene.selected.config.imageLeft.url", "appData.scene.selected.config.imageRight.url", "appData.scene.selected.config.imageTop.url", "appData.scene.selected.config.imageBottom.url"], jQuery.proxy(function() {
            this.appData.scene.dirty = !0
          }, a)), a.$watchGroup(["appData.hotspot.selected", "appData.hotspot.selected.isVisible", "appData.hotspot.selected.config.title", "appData.hotspot.selected.config.yaw", "appData.hotspot.selected.config.pitch"], jQuery.proxy(function() {
          ...
          for (var g = a.appData.config.scenes.length; g--;) {
            ...
            if (k.isSelected) {
              ...
              for (var g = a.appData.scene.selected.config.hotspots.length; g--;) {
                var l = a.appData.scene.selected.config.hotspots[g];
                if (l.isSelected) {
          ...
          a.appData.fn.workspace.layout(a.appData), a.appData.fn.workspace.refreshScene(a.appData)
        },
        resize: function(a) {
        ...
        onHotspotSetup: function(a, b, c, d, e, f) {
          (f.ctrlKey || f.metaKey) && (this.appData.targetTool ? this.appData.fn.hotspots.add(this.appData, a, b) : this.appData.hotspot.selected && (this.appData.hotspot.selected.config.yaw = a, this.appData.hotspot.selected.config.pitch = b, this.appData.hotspot.dirty = !0))
        },
        updateScene: function(a) {
          a.panoramaReady && (a.$panorama.ipanorama("destroy"), a.panoramaReady = !1), a.scene.selected && (a.panoramaCfg.sceneId = "main", "cube" == a.scene.selected.config.type ? "single" == a.scene.selected.config.cubeTextureCount ? a.panoramaCfg.scenes = {
            main: {
              type: "cube",
              ...
              image: a.fn.getImageUrl(a, a.scene.selected.config.imageFront)
            }
            ...
            main: {
              ...
              zoom: a.scene.selected.zoom,
              image: {
                front: a.fn.getImageUrl(a, a.scene.selected.config.imageFront),
                back: a.fn.getImageUrl(a, a.scene.selected.config.imageBack),
                left: a.fn.getImageUrl(a, a.scene.selected.config.imageLeft),
                right: a.fn.getImageUrl(a, a.scene.selected.config.imageRight),
                top: a.fn.getImageUrl(a, a.scene.selected.config.imageTop),
                bottom: a.fn.getImageUrl(a, a.scene.selected.config.imageBottom)
              }
            }
          ...
          if (a.panoramaReady && a.hotspot.dirty) {
            for (var b = [], c = 0; c < a.scene.selected.config.hotspots.length; c++) {
              var d = a.scene.selected.config.hotspots[c],
                e = {};
              d.isVisible && (e.yaw = d.config.yaw, e.pitch = d.config.pitch, e.className = "ipnrm-ui-hotspot", e.content = '<div class="ipnrm-ui-hotspot-label">' + (d.config.title ? d.config.title : d.id) + "</div>", b.push(e))
            }
    ...
    modal: {
      ...
      fn: {
        show: function(a, b, c, d) {
          var e = ++a.modal.count,
            f = a.srv.$q.defer();
          return a.modal.items.push(e), a.inprocess++, a.srv.$templateRequest(b).then(function(b) {
            var d = ipnrm_angular.element(b);
            jQuery("body").addClass("ipnrm-ui-modal-open"), (void 0 == c.easyClose || c.easyClose) && d.on("click", function(a) {
              g.modalData.deferred.resolve("close")
            }), d.find(".ipnrm-ui-modal-dialog").on("click", function(a) {
              return a.preventDefault(), !1
            }), d.on("click", function(b) {
              a.modal.fn.close(a, e)
            }), d.addClass("ipnrm-ui-modal-hidden"), jQuery(".ipnrm-ui-modals").append(d);
            var g = a.srv.$root.$new(!0);
            g.modalData = c, g.modalData.id = e, g.modalData.deferred = f, g.modalData.appData = a, a.srv.$compile(d)(g), setTimeout(function() {
              d.removeClass("ipnrm-ui-modal-hidden")
            }, 1)
          })["finally"](function() {
            d && "function" == typeof d && d.call(this), a.inprocess--
          }), f.promise
        },
        close: function(a, b) {
          jQuery("#ipnrm-ui-modal-" + b).remove();
          var c = a.modal.items.indexOf(b);
          a.modal.items.splice(c, 1), 0 == a.modal.items.length && jQuery("body").removeClass("ipnrm-ui-modal-open")
        }
      }
    },
    srv: {
  ...
  window.iPanoramaAppData = b, ipnrm_angular.module("ngiPanoramaApp", ["ngiPanoramaApp.services", "ngiPanoramaApp.controllers", "ngiPanoramaApp.directives", "ngiPanoramaApp.filters"]).run(["$rootScope", function(a) {
    a.safeApply = function(a) {
      var b = this.$root.$$phase;
      return "$apply" !== b && "$digest" !== b ? void this.$apply(a) : void(a && "function" == typeof a && a())
    }
  }]), ipnrm_angular.module("ngiPanoramaApp.services", []).factory("appData", function() {
    return b
  }), ipnrm_angular.module("ngiPanoramaApp.controllers", []).controller("ngiPanoramaAppController", ["$scope", "$compile", "$timeout", "$templateRequest", "$http", "$q", "appData", function(a, b, c, d, e, f, g) {
    g.srv.$compile = b, g.srv.$timeout = c, g.srv.$templateRequest = d, g.srv.$http = e, g.srv.$q = f, g.srv.$root = a.$root, a.appData = g
  }]), ipnrm_angular.module("ngiPanoramaApp.directives", []).directive("workspace", ["appData", function(a) {
    return {
      scope: {
        initFunc: "=init"
      },
  ...
  }]).directive("tabPanelItem", ["appData", function(a) {
    return {
      scope: {
        id: "@id",
        initFunc: "=init"
    ...
    function a(a, b, c, d) {
      ...
      function f() {
        d.$viewValue ? b.addClass("ipnrm-ui-checked") : b.removeClass("ipnrm-ui-checked")
      }
  ...
  }), ipnrm_angular.module("ngiPanoramaApp.filters", []).filter("with", function() {
    return function(a, b) {
      var c = {};
      return ipnrm_angular.forEach(a, function(a, d) {
  ...
  }), ipnrm_angular.element(document.getElementById("ipnrm-ui-app")).ready(function() {
    ipnrm_angular.bootstrap(document.getElementById("ipnrm-ui-app"), ["ngiPanoramaApp"])
  })
}();

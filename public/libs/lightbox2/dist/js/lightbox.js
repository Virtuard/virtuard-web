...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function () {
    ...
    $(
      '<div id="lightboxOverlay" tabindex="-1" class="lightboxOverlay"></div>' +
        ...
        '<img class="lb-image" src="path/to/your/image.jpg" alt="Your Image Alt Text"/>' +
  ...
  Lightbox.prototype.changeImage = function (imageNumber) {
    ...
    this.$lightbox
      .find(
        ".lb-image, .lb-nav, .lb-prev, .lb-next, .lb-dataContainer, .lb-numbers, .lb-text"
      )
      .hide();
  ...
  Lightbox.prototype.updateDetails = function () {
    var self = this;
    var $container = this.$lightbox.find(".lb-textContainer");
    ...
    if (
      ...
      var $caption = this.$lightbox.find(".lb-text");
      $container.removeClass("d-none");
      if (this.options.sanitizeTitle) {
        $caption.text(this.album[this.currentImageIndex].title);
        $caption.attr('href', this.album[this.currentImageIndex].story);
      } else {

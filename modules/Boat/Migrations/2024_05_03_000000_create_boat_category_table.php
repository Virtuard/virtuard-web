...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bravo_boat_category', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bravo_boat_category_translations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('origin_id')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('boat_category');
        Schema::dropIfExists('boat_category_translations');
    }
};

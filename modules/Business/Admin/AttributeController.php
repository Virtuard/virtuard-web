...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'business');
        ...
        return view('Business::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'business')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Business'),
        ...
        return view('Business::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Business::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('business.admin.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
        ...
        return view('Business::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('business');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('business',$q);

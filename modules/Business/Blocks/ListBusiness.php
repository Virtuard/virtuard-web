...
class ListBusiness extends BaseBlock
{
        ...
        return [
            'settings' => [
                ...
                [
                    ...
                    'select2'      => [
                        'ajax'        => [
                            'url'      => route('business.admin.getForSelect2'),
                            'dataType' => 'json'
                        ],
                        'width'       => '100%',
                        'multiple'    => "true",
                    ...
                    'pre_selected' => route('business.admin.getForSelect2', [
                        'pre_selected' => 1
                    ])
                ],
            ],

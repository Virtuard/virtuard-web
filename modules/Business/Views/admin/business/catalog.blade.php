<div class="form-group-item">
    ...
    <div class="g-items">
        @if(!empty($translation->catalogs))

            @php if(!is_array($translation->catalogs)) $translation->catalogs = json_decode($translation->catalogs); @endphp

            @foreach($translation->catalogs as $key=>$catalog)
...
$(document).ready(function() {
    ...
    console.log('Catalogs data:', @json($translation->catalogs ?? []));

...
class CreateBusinessTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_businesses', function (Blueprint $table) {
        ...
        Schema::create('bravo_business_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_business_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_business_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bravo_businesses');
        Schema::dropIfExists('bravo_business_translations');
        Schema::dropIfExists('bravo_business_term');
        Schema::dropIfExists('bravo_business_dates');
    }
}

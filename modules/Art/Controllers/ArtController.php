...
class ArtController extends Controller
{
    ...
    public function __construct(Art $artClass, Location $locationClass,LocationCategory $locationCategoryClass)
    {
    ...
    public function index(Request $request)
    {
        ...
        if ($is_ajax) {
            return $this->sendSuccess([
                'html'    => view('Art::frontend.layouts.search-map.list-item', $data)->render(),
        ...
        if ($layout == "map") {
            ...
            return view('Art::frontend.search-map', $data);
        }
        return view('Art::frontend.search', $data);
    }

    public function detail(Request $request, $slug)
    {
        $row = $this->artClass::where('slug', $slug)->with(['location','translation','hasWishList'])->first();;
        ...
        if (!empty($location_id)) {
            $art_related = $this->artClass::where('location_id', $location_id)->where("status", "publish")->take(4)->whereNotIn('id', [$row->id])->with(['location','translation','hasWishList'])->get();
        }

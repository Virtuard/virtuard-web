...
class CreateArtTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_arts', function (Blueprint $table) {
        ...
        Schema::create('bravo_art_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_art_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_art_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bravo_arts');
        Schema::dropIfExists('bravo_art_translations');
        Schema::dropIfExists('bravo_art_dates');
        Schema::dropIfExists('bravo_art_term');
    }
}

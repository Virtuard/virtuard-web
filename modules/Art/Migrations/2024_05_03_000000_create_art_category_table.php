...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bravo_art_category', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bravo_art_category_translations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('origin_id')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('art_category_translations');
    }
};

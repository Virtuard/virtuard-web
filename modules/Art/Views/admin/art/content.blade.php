<div class="panel">
    <div class="panel-title"><strong>{{ __('Rendering and Art') }}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{ __('Title') }}</label>
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{ __('Name of the Rendering and Art') }}" name="title" class="form-control">
        </div>
        <div class="form-group">

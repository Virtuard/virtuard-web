...
class CreateCulturalTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_culturals', function (Blueprint $table) {
        ...
        Schema::create('bravo_cultural_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_cultural_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_cultural_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bravo_culturals');
        Schema::dropIfExists('bravo_cultural_translations');
        Schema::dropIfExists('bravo_cultural_dates');
        Schema::dropIfExists('bravo_cultural_term');
    }
}

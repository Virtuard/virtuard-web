...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bravo_cultural_category', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bravo_cultural_category_translations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('origin_id')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('cultural_category');
        Schema::dropIfExists('cultural_category_translations');
    }
};

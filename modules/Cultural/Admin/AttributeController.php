...
class AttributeController extends AdminController
{
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('cultural.admin.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('cultural');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('cultural',$q);

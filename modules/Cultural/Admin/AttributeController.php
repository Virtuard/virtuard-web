...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'cultural');
        ...
        return view('Cultural::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'cultural')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Cultural'),
        ...
        return view('Cultural::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Cultural::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('cultural.admin.attribute.term.index',['attr_id'=>$row->attr_id])
                ],
                [
        ...
        return view('Cultural::admin.terms.detail', $data);
    }

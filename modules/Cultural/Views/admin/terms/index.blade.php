        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('cultural.admin.attribute.term.editTermBulk')}}" class="filter-form filter-form-left d-flex justify-content-start">
                                {{csrf_field()}}
                    ...
                    <div class="col-left">
                        <form method="get" action="{{ route('cultural.admin.attribute.term.index',['attr_id' => $attr->id]) }} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                                ...
                                @if(count($rows) > 0)
                                    @foreach ($rows as $row)
                                        <tr>
                                            ...
                                            <td class="title">
                                                <a href="{{route('cultural.admin.attribute.term.edit', ['id' => $row->id])}}">{{$row->name}}</a>
                                            </td>

...
Route::group(['prefix'=>'attribute'],function(){
    ...
    Route::get('/terms/{attr_id}','AttributeController@terms')->name('cultural.admin.attribute.term.index');
    Route::get('/term_edit/{id}','AttributeController@term_edit')->name('cultural.admin.attribute.term.edit');
    Route::post('/term_store/{id}','AttributeController@term_store')->name('cultural.admin.attribute.term.store');
...
Route::get('/booking','BookingController@index')->name('cultural.admin.booking.index');

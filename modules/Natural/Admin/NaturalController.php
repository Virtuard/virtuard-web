...
class CulturalController extends AdminController
{
    ...
    public function __construct(Cultural $natural, CulturalTranslation $natural_translation, CulturalTerm $natural_term, Attributes $attributes, Location $location,LocationCategory $locationCategoryClass)
    {
    ...
    public function create(Request $request)
    {
        ...
        return view('Cultural::admin.detail', ['data' => $data, 'isVirtuard360' => $isVirtuard360, 'dataIpanorama' => $dataIpanorama, 'row' => $row, 'translation' => $data['translation'], 'location_category' => $data['location_category'], 'attributes' => $data['attributes'], 'breadcrumbs' => $data['breadcrumbs'], 'natural_location' => $data['natural_location'], 'categories' => $categories, ]);
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($res) {
            ...
            if ($id > 0) {
                ...
                return redirect(route('natural.admin.edit', $row->id))->with('success', __('Cultural created'));
            }
        }
    }

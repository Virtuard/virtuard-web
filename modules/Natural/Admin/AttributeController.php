...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'natural');
        ...
        return view('Natural::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'natural')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Natural'),
        ...
        return view('Natural::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Natural::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('natural.admin.attribute.term.index',['attr_id'=>$row->attr_id])
                ],
                [
        ...
        return view('Natural::admin.terms.detail', $data);
    }

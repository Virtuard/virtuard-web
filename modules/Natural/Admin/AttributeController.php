...
class AttributeController extends AdminController
{
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('natural.admin.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('natural');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('natural',$q);

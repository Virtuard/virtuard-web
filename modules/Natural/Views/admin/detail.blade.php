        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->slug)
                        <p class="item-url-demo">{{__("Permalink")}}: {{ url('natural' ) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a>
                        </p>
                    @endif
                </div>
                <div class="">
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        @include('Natural::admin.natural.content')
                        @include('Natural::admin.natural.pricing')
                        @include('Natural::admin.natural.location')
                    ...
                    <div class="col-md-3">
                        ...
                        @if(is_default_lang())
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>{{__('Natural Featured')}}</label>
                                        <br>
                                        <label>

...
class CreateNaturalTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bravo_naturals', function (Blueprint $table) {
        ...
        Schema::create('bravo_natural_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_natural_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_natural_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bravo_naturals');
        Schema::dropIfExists('bravo_natural_translations');
        Schema::dropIfExists('bravo_natural_dates');
        Schema::dropIfExists('bravo_natural_term');
    }
}

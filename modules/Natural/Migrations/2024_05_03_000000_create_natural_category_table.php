...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bravo_natural_category', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bravo_natural_category_translations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('origin_id')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('natural_category');
        Schema::dropIfExists('natural_category_translations');
    }
};

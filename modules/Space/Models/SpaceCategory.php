...
class SpaceCategory extends BaseModel
{
    use SoftDeletes;
    use NodeTrait;
    protected $table = 'bravo_space_category';
    protected $fillable = [
        'name',
        'content',
        'slug',
    ...
    protected $translation_class = SpaceCategoryTranslation::class;
    ...
    public function getDetailUrl(){
        return url(app_get_locale(false, false, '/') . config('space.space_route_prefix').'?cat_id[]='.$this->id);
    }

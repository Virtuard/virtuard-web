...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bravo_space_category', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bravo_space_category_translations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('origin_id')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('space_category_translations');
    }
};

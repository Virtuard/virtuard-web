<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <input type="password" class="form-control password-input" name="password" id="password" autocomplete="off" placeholder="{{__('Password')}}">
        <span class="toggle-password input-icon icofont-eye-blocked" id="toggle-password" style="cursor: pointer;"></span>

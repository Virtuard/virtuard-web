...
use Modules\Api\Controllers\Auth\AppleLoginController;
...
Route::group(['middleware' => 'api', 'prefix' => 'auth'], function ($router) {
    ...
    // Apple Login (required by App Store Guideline 4.8)
...
Route::group(['prefix' => 'post', 'middleware' => ['auth:sanctum'],], function () {
    ...
    Route::post('/{id}/report-stats', [ControllersPostController::class, 'reportStats']);
});

...
@push('js')
    ...
    <script>
        ...
        var bravo_booking_i18n = {
                ...
                load_dates_url:'{{route('cultural.vendor.availability.loadDates')}}',
    ...
    <script type="text/javascript" src="{{ asset('module/cultural/js/single-tour.js?_ver='.config('app.asset_version')) }}"></script>

...
@section('content')
    <div class="bravo_search_tour">
        <h1 class="d-none">
            {{setting_item_with_lang("cultural_page_search_title")}}
        </h1>
        <div class="bravo_form_search_map">
            @include('Cultural::frontend.layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map {{ setting_item_with_lang("cultural_layout_map_option",false,"map_left") }}">
...
@push('js')
    ...
    <script>
        var bravo_map_data = {
            ...
            map_lat_default:{{setting_item('cultural_map_lat_default','0')}},
            map_lng_default:{{setting_item('cultural_map_lng_default','0')}},
            map_zoom_default:{{setting_item('cultural_map_zoom_default','6')}},
        };
    </script>

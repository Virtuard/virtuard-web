            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-9">
                        ...
                        <div id="panorama"></div>
                        @endif
                        @include('Natural::frontend.layouts.details.detail')
                        @include('Natural::frontend.layouts.details.review')
                    </div>
                ...
                <div class="row end_tour_sticky">
                    <div class="col-md-12">
                        @include('Natural::frontend.layouts.details.related')
                    </div>
                </div>
            </div>
        </div>
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('module/natural/js/single-event.js?_ver='.config('app.asset_version')) }}"></script>

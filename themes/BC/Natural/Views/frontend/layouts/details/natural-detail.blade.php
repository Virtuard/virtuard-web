<div class="g-header">
    ...
    <div class="right">
        @if(setting_item('natural_enable_review') and $review_score)
...
@if(!empty($row->duration) or !empty($row->category_natural->name) or !empty($row->max_people) or !empty($row->location->name))
    ...
    <div class="row">
        ...
        @endif
        @if(!empty($row->category_natural->name))
            @php $cat =  $row->category_natural->translate() @endphp
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    <div class="icon">
                    ...
                    <div class="info">
                        <h4 class="name">{{__("Natural Type")}}</h4>
                        <p class="value">
                            {{$cat->name ?? ''}}
                        </p>
                    </div>
...
@endif
@include('Natural::frontend.layouts.details.natural-include-exclude')
@include('Natural::frontend.layouts.details.natural-itinerary')
@include('Natural::frontend.layouts.details.natural-attributes')
@include('Natural::frontend.layouts.details.natural-faqs')
@includeIf("Hotel::frontend.layouts.details.hotel-surrounding")

@if($row->map_lat && $row->map_lng)
<div class="g-location">
    <div class="location-title">
        <h3>{{__("Natural Location")}}</h3>
        @if($translation->address)
            <div class="address">

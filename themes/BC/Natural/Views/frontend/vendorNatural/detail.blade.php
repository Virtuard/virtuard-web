...
@section('content')
    <h2 class="title-bar no-border-bottom">
        {{$row->id ? __('Edit: ').$row->title : __('listing.natural.add')}}
    </h2>
            ...
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        @include('Natural::admin/natural/location',["is_smart_search"=>"1"])
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <a href="{{ route('natural.vendor.availability.index') }}" class="btn btn-warning btn-sm" target="_blank"><i class="fa fa-calendar"></i> {{  __('Availability Naturals') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

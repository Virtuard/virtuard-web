...
<div class="form-group">
    ...
    <div class="form-content">
        ...
        <div class="smart-search">
            <input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("art_location_search_style")) or setting_item("art_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Select Category")}}" value="{{ $category_name }}" data-onLoad="{{__("Loading...")}}"

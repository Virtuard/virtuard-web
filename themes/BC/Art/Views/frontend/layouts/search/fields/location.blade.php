...
<div class="form-group">
    <div class="form-content">
        ...
        <div class="smart-search d-flex justify-content-between align-items-center">
            <input type="text" aria-label='location_id' class='form-control autocomplete location-event' id='location_id' name='location_id' placeholder="Location" style="border-top: none;border-left:none;border-right:none;">

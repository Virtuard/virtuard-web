...
@section ('content')
        ...
        <div class="panel-title d-flex justify-content-between">
            ...
            @if(request()->has('id'))
                <div class="form-group">
                    <a href="{{ route('business.vendor.edit', request('id')) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> {{  __('Back to Editor') }}</a>
                </div>
            @endif
        </div>
    ...
    @else
        <div class="alert alert-warning">{{__("No business found")}}</div>
    @endif
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"{{route('business.vendor.availability.loadDates')}}",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('business.vendor.availability.store')}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',

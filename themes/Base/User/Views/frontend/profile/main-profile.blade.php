        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="">
                    ...
                    <p>{!! __("On Every person who registers you through your referral you will have 10% of the Virtuard revenues generated by him forever and you can Monitor on <a href='https://virtuard.com/vendor/referral'>Referral page</a>") !!}</p>
                </div>
            </div>
        </div>
    </div>
